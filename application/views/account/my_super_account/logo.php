...
<div class="left" style="width: 40%;">
  ...
  padding-right: 0.75rem;" for="inputImage" title="Upload image file">
        ...
        <img style="width: 200px; height: auto; display: block; margin: 0 auto;" src="<?php echo site_url('account/getSuperUserLogo'); ?>" alt="">
    </div>
</div>
...
<script src="<?php echo site_url('/3rdparty/cropper/js/main_user.js') ?>"></script>
