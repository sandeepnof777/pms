<h3>
    ...
    <a href="<?php echo site_url('account/my_super_account') ?>">Back</a>
</h3>
<form action="<?php echo site_url('account/edit_parent_company_info') ?>" method="post" class="form-validated">
