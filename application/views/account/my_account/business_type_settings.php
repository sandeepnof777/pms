...
<h3>
    &nbsp;
<!-- <a style="font-size: 12px; padding: 2px 5px;" class="btn ui-button update-button " href="<?php echo site_url('account/my_account') ?>">Back</a> -->
    Business Type
    <div class="right">

                   <a class="btn ui-button update-button addNewType" style="font-size: 12px; padding: 2px 5px;" href="javascript:void(0);">Add New</a>
                ...
                <div class="box-content">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="boxed-table"
                        ...
                        foreach ($businessTypes as $businessType) {
                            ...
                            ?>
                            <tr  id="type_<?php echo $businessType->getId(); ?>">
                                ...
                                <td style="text-align: center">
                                <a href="#" class="tiptip btn-delete delete-type" style="display: inline-block;float: right;margin-left: 5px;" title="Delete Business Type"  data-type-id="<?php echo $businessType->getId(); ?>" >&nbsp;</a>
                                <?php if($businessType->getCompanyId()){?>
                                        <a href="#" class="tiptip btn-edit edit-type" style="display: inline-block;float: right;" title="Edit Business Type"  data-type-id="<?php echo $businessType->getId(); ?>"
        ...
        updateRowColors();
            ...
            $('.type-sortable').sortable({
                    ...
                    stop: function () {
                        ...
                        $.ajax({
                            url: '<?php echo site_url('account/order_company_business_type') ?>',
                            type: "POST",
                            data: ordered_data,
                            dataType: "json",
        ...
        var type_id = $(this).attr('data-type-id');
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: '/account/business_type_settings',
                        type: "POST",
                        dataType: "JSON",
                        data: {
                            action: 'delete',
                        ...
                        success: function( data){
                            ...
                            document.location.href = '<?php echo site_url('account/business_type_settings') ?>';
