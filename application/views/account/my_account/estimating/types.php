...
<a class="m-btn " id="addNewType" href="#" style="position: absolute;right:12px;margin-top: -37px;">
    <i class="fa fa-fw fa-plus"></i> Add Type
</a>
<!-- <a class="m-btn "  href="<?php echo site_url('account/my_account/proposal_settings') ?>" style="float:right;margin-right:10px; margin-top: -37px;" >
      Back
</a> -->
</div>
 
<!-- <div style="height:30px;">
<a class="m-btn " style="float:right;margin-right:15px; margin-top: 12px;font-size: 14px;font-weight: bold;" href="<?php echo site_url('account/my_account/proposal_settings') ?>">Back</a>
</div> -->
    ...
    <div class="content-box" id="add-type">
        ...
        <div class="box-content">
            <form autocomplete="off" class="form-validated" accept-charset="utf-8" method="post"
                  action="<?php echo site_url('account/saveEstimatingType') ?>">
    ...
    $(document).ready(function () {
        ...
        //$(".sortable-types").sortable({
            ...
            stop:function () {
                ...
                $.ajax({
                    type:"POST",
                    url:"<?php echo site_url('ajax/updateEstimationTypeOrder') ?>",
                    data:postData,
                    async:false
                });
            }
        ...
        $(".assignType").click(function() {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('ajax/getCompanyServiceTypeAssignments'); ?>",
                dataType: "JSON"
            })
        ...
        $("#saveAssignments").click(function() {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('ajax/companyServiceTypeAssign'); ?>",
                dataType: "JSON"
            })
            .success(function (data) {
                if (!data.error) {
