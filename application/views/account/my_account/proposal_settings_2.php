...
<!-- <a href="<?php echo site_url('account/my_account/proposal_settings') ?>">Back</a> -->
 ...
 <form action="<?php echo site_url('account/company_proposal_settings2') ?>" method="post" class="form-validated">
    <table class="boxed-table" width="100%" cellpadding="0" cellspacing="0">
        <tbody>
        <tr class="even">
            <td>
                <div class="clearfix">
                    <textarea tabindex="30" name="aboutCompany" class="trackChanges" id="aboutCompany" cols="30"
                              rows="20"
                              style="width: 100%; clear: right;"><?php echo $company->getAboutCompany() ?></textarea>
                </div>
                <p class="clearfix" id="wordCountText"><br>
                    <strong><span id="numWordsRemaining"><?= ABOUT_US_WORD_LIMIT; ?></span></strong> words remaining
                </p>
            </td>
        </tr>
        <tr class="even">
...
<script type="text/javascript">
    var wordLimit = <?= ABOUT_US_WORD_LIMIT; ?>;

    $(document).ready(function () {
        //CKEDITOR.replace('aboutCompany');
        tinymce.init({
            selector: "textarea#aboutCompany",
            menubar: false,
            relative_urls: false,
