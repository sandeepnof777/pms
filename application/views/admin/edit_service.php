...
<div id="content" class="clearfix">
    <div class="widthfix">
        ...
        } ?><span class="editServiceName tiptip" title="Click to edit" id="<?php echo $service->getServiceId() ?>"><?php echo $service->getServiceName() ?></h4>
        <div class="content-box left" id="service-customtexts">
            <div class="box-header">
                Service Texts
                <a href="<?php echo site_url('admin/manage_services') ?>" class="box-action tiptip" title="Go Back">Back</a>
                    ...
                    <div id="service-texts-edit"><?php
                        ...
                        foreach ($texts as $text) {
                            ...
                            <span class="actions">
                                ...
                                <a class="btn-delete tiptip delete-text" title="Delete Text" href="<?php echo site_url('admin/delete_service_text/' . $text->getTextId()) ?>">Delete Text</a>
                            </span>
                            </div>
                            <?php
                        }
        ...
        <div id="service-fields" class="right">
                            ...
                            foreach ($fields as $field) {
                                ...
                                <div class="<?php echo ($k % 2) ? 'odd' : '' ?> field clearfix" id="fields_<?php echo $field->getFieldId() ?>">
                                    ...
                                    <span class="actions">
                                        ...
                                        <a class="btn-delete tiptip delete-field" href="<?php echo site_url('admin/delete_service_field/' . $field->getFieldId()) ?>" title="Delete Field">Delete Field</a>
                                    </span>
                                </div>
                                <?php
                            }
            ...
            <div class="content-box right" id="service-addfield">
                ...
                <div class="box-content">
                    <form autocomplete="off" class="form-validated" accept-charset="utf-8" method="post" action="<?php echo site_url('admin/edit_service/' . $service->getServiceId()) ?>">
                                ...
                                <td>
                                    <p class="clearfix left">
                                        ...
                                        <select name="fieldType" id="fieldType">
                                            ...
                                            <option value="texttext">Text - Any</option>
...
<script type="text/javascript">
    $(document).ready(function () {
        //Edit Category Name
        $(".editServiceName").editable('<?php echo site_url('admin/editServiceCatName') ?>', {
            cancel:'Cancel',
            submit:'OK',
            width:510,
            height:100
        ...
        $("#service-fields-edit").sortable({
            ...
            stop:function () {
                ...
                var postData = $("#service-fields-edit").sortable("serialize");
                $.ajax({
                    type:"POST",
                    url:"<?php echo site_url('admin/updateServiceFieldsOrder') ?>",
                    data:postData,
                    async:false
                });
            }
        ...
        function setTextsOrder() {
            var postData = $("#service-texts-edit").sortable("serialize");
            $.ajax({
                type:"POST",
                url:"<?php echo site_url('admin/updateServiceTextsOrder') ?>",
                data:postData,
                async:false
            });
        }
        ...
        $(".edit-field").click(function () {
            ...
            $.getJSON('<?php echo site_url('admin/get_field_info') ?>/' + fieldId, function (data) {
...
//            CKEDITOR.instances.addTextText.setData('');
        ...
        $("#addAtCursor").click(function () {
            ...
            tinymce.get("addTextText").execCommand('mceInsertContent', false, $("#addTag").val());
        ...
        $("#addAtCursorEdit").click(function () {
            ...
            tinymce.get("editServiceText").execCommand('mceInsertContent', false, $("#addTagEdit").val());
        });
...
<div id="edit-field" title="Edit Field" style="padding: 0;">
    <form class="form-validated" accept-charset="utf-8" method="post" action="<?php echo site_url('admin/edit_service/' . $service->getServiceId()) ?>" id="edit-field-form">
...
<div id="add-servicetext" title="Add New Text">
    ...
    <form action="<?php echo site_url('admin/edit_service/' . $this->uri->segment(3)) ?>" method="post" id="add-servicetext-form">
...
<div id="edit-servicetext" title="Edit Text">
    ...
    <form action="<?php echo site_url('admin/edit_service/' . $this->uri->segment(3)) ?>" method="post" id="edit-servicetext-form">
