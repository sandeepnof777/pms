                        ...
                        <div class="m-btn groupAction tiptip groupActionsButton" title="Carry out actions on selected proposals"
                            ...
                            <div class="materialize groupActionsContainer" style="width:300px">
                                <div class="collection groupActionItems">
                                    ...
                                    <a href="javascript:void(0);" onclick="enableGroupSalesManager()" class="enableGroupEstimating collection-item iconLink">
                                        <i class="fa fa-fw fa-external-link"></i> Enable Sales Manager
                                    </a>
                                    <a href="javascript:void(0);" onclick="disableGroupSalesManager()" class="collection-item iconLink">
                                        <i class="fa fa-fw fa-times"></i> Disable Sales Manager
                                    </a>

                                    <a href="javascript:void(0);" onclick="enableGroupModifyPrice()" class="enableGroupEstimating collection-item iconLink">
                                        <i class="fa fa-fw fa-external-link"></i> Enable Modify Price
                                    </a>
                                    <a href="javascript:void(0);" onclick="disableGroupModifyPrice()" class="collection-item iconLink">
                                        <i class="fa fa-fw fa-times"></i> Disable Modify Price
                                    </a>

                                    <a href="javascript:void(0);" onclick="enableGroupProposalCampaigns()" class="enableGroupEstimating collection-item iconLink">
                                        <i class="fa fa-fw fa-external-link"></i> Enable Proposal Campaigns
                                    </a>
                                    <a href="javascript:void(0);" onclick="disableGroupProposalCampaigns()" class="collection-item iconLink">
                                        <i class="fa fa-fw fa-times"></i> Disable Proposal Campaigns
                                    </a>
                                    <!--satrt code for customer checklist-->
                                    <a href="javascript:void(0);" onclick="enableGroupCustomerChecklist()" class="enableGroupEstimating collection-item iconLink">
                                        <i class="fa fa-fw fa-external-link"></i> Enable Customer Checklist
                                    </a>
                                    <a href="javascript:void(0);" onclick="disableGroupCustomerChecklist()" class="collection-item iconLink">
                                        <i class="fa fa-fw fa-times"></i> Disable Customer Checklist
                                    </a>
                                    <!--close code for customer checklist-->
        ...
        <div class="content-box">
            <div class="box-header centered" style="position: relative;">
                ...
                <div style="position: absolute; right: 10px; top: 6px;">
                    <a class="box-action" href="<?php echo site_url('admin/add_company') ?>">Add Company</a>
                </div>
            </div>
            <div class="box-content">
                <table cellpadding="0" cellspacing="0" border="0" class="dataTables-admin display">
                    ...
                    <tr>
                        ...
                        <td>PSA</td>
                        <td>Est.</td>
                        <td style="white-space:nowrap;">Sales Mgr</td>
                        <td style="white-space:nowrap;">Modify Price</td>
                        <td>Campaign</td>
                    </tr>
                    </thead>
                    <tbody>
...
$(document).ready(function () {
     ...
     adminTable = $('.dataTables-admin').DataTable({
        "bServerSide": true,
        "ajax": {
            "url": "<?php echo site_url('admin/companiesTableData'); ?>"
        },
        "aoColumns": [
            {bSortable: false},
            null, //0
            ...
            // {"bSearchable": false, 'sortable': false} //11
        ],
        "scrollCollapse": true,
            "scrollX": true,
        "bJQueryUI": true,
...
$(document).on('click', ".adminTableDropdownToggle", function(e) {
    ...
    var sales_manager = $(this).attr('data-company-sales-manager');
    var modify_price = $(this).attr('data-modify-price');
    var is_proposal = $(this).attr('data-proposal');
    var proposal_checklist = $(this).attr('data-proposal-checklist');
    ...
    //for sales manager
    if(sales_manager == 0){
        $('#enableSalesManager').css('display', 'block');
        $('#disableSalesManager').css('display', 'none');
    } else {
        $('#disableSalesManager').css('display', 'block');
        $('#enableSalesManager').css('display', 'none');
    }
    // for modify price
    if(modify_price == 0){
        $('#enableModifyPrice').css('display', 'block');
        $('#disableModifyPrice').css('display', 'none');
    } else {
        $('#disableModifyPrice').css('display', 'block');
        $('#enableModifyPrice').css('display', 'none');
    }

    // for proposal
    if(is_proposal == 0){
        $('#enableProposalCampaigns').css('display', 'block');
        $('#disableProposalCampaigns').css('display', 'none');
    } else {
        $('#disableProposalCampaigns').css('display', 'block');
        $('#enableProposalCampaigns').css('display', 'none');
    }

        //for proposal checklist
        if(proposal_checklist == 0){
        $('#enableProposalChecklist').css('display', 'block');
        $('#disableProposalChecklist').css('display', 'none');
    } else {
        $('#disableProposalChecklist').css('display', 'block');
        $('#enableProposalChecklist').css('display', 'none');
    }
    ...
    template = template.replace(new RegExp('{sales_manager}','g'), sales_manager);
    template = template.replace(new RegExp('{modify_price}','g'), modify_price);
    template = template.replace(new RegExp('{is_proposal}','g'), is_proposal);
    template = template.replace(new RegExp('{proposal_checklist}','g'), proposal_checklist);
...
<div id="template" style="display:none">
    ...
    <div class="dropdownMenuContainer template_class">
        ...
        <ul class="dropdownMenu" style="float: left;width: 220px">
            ...
            <li>
                <a href="<?php echo site_url('admin/accounts/{companyId}') ?>"><img
            ...
            <li>
                <a href="<?php echo site_url('admin/add_account/{companyId}') ?>"><img
        ...
        <ul class="dropdownMenu" style="float: left;width: 220px">
            ...
            <li>
                    <a onclick="show_loader();" href="<?php echo site_url('admin/enableSalesManager/{companyId}') ?>" id="enableSalesManager" style="display: none;"><img
                                src="/3rdparty/icons/user_suit.png">
                        Enable Sales Manager</a>

                    <a onclick="show_loader();" href="<?php echo site_url('admin/disableSalesManager/{companyId}') ?>" id="disableSalesManager" style="display: none;"><img
                                src="/3rdparty/icons/user_suit.png">
                        Disable Sales Manager</a>
            </li>

            <li>
                    <a onclick="show_loader();" href="<?php echo site_url('admin/enableModifyPrice/{companyId}') ?>" id="enableModifyPrice" style="display: none;">
                    <i class="fa fa-fw fa-usd"></i>
                    &nbsp;&nbsp;Enable Modify Price</a>

                    <a onclick="show_loader();" href="<?php echo site_url('admin/disableModifyPrice/{companyId}') ?>" id="disableModifyPrice" style="display: none;">
                      <i class="fa fa-fw fa-usd"></i>
                      &nbsp;&nbsp;Disable Modify Price</a>
            </li>

            <li>
                    <a onclick="show_loader();" href="<?php echo site_url('admin/enableProposalCampaigns/{companyId}') ?>" id="enableProposalCampaigns" style="display: none;">
                    <img src="/3rdparty/icons/book_edit.png">
                       Enable Proposal Campaigns</a>

                    <a onclick="show_loader();" href="<?php echo site_url('admin/disableProposalCampaigns/{companyId}') ?>" id="disableProposalCampaigns" style="display: none;">
                    <img src="/3rdparty/icons/book_edit.png">
                        Disable Proposal Campaigns</a>
            </li>

            <li>
                    <a onclick="show_loader();" href="<?php echo site_url('admin/enableProposalChecklist/{companyId}') ?>" id="enableProposalChecklist" style="display: none;"><img
                                src="/3rdparty/icons/building_edit.png">
                        Enable Proposal checklist</a>

                    <a onclick="show_loader();" href="<?php echo site_url('admin/disableProposalChecklist/{companyId}') ?>" id="disableProposalChecklist" style="display: none;"><img
                                src="/3rdparty/icons/building_edit.png">
                        Disable Proposal checklist</a>
            </li>
...
<div id="resend-proposals" title="Send Email to Selected Companies Users" style="padding: 0 !important;">
    <form action="<?php echo site_url('admin/sendEmail') ?>" method="post">
        <table class="boxed-table" style="width: 100%;" cellpadding="0" cellspacing="0">
            <tbody>
            <tr>
                <td  style="width: 15%;text-align: left;font-weight:bold">Email Template: </td>
                ...
                <td style="text-align: left;font-weight:bold">Choose Users: </td>
                <td >
            ...
            <tr class="even">
                <td style="width: 15%;text-align: left;font-weight:bold"><span >Choose Campaign: </span></td>
                    <td style="width: 29%;"><select name="resendId" id="resendSelect" >
            ...
            <tr>
                ...
                <td colspan="3"><input class="text" type="text" id="messageSubject" style="width: 280px;"></td>
            </tr>
            <tr>
            <td style="width: 13%;text-align: left;font-weight:bold">From Name: </td>
                ...
                <td><input type="text" name="fromEmail" id="fromEmail" class="text" value="contact@<?php echo SITE_EMAIL_DOMAIN; ?>"/></td>
            ...
            <tr class="even">
                <td style="text-align: left;font-weight:bold">Message: </td>
                <td colspan="3"><span id="unlock_editor_span"><input type="checkbox" name="unlock_editor" id="unlock_editor"><span style="padding-top: 6px;position: absolute;">Edit and send as new campaign</span></span> </td>
            </tr>
            <tr>
                <td colspan="4">
...
// getEnable SalesMangerSelectedIds
function getEnableSalesMangerSelectedIds(){
        var IDs = new Array();
...
function enableGroupEstimating() {
    $("#loading").dialog('open');
        ...
        // enable Group SalesManager
        function enableGroupSalesManager() {
    $("#loading").dialog('open');
            $.ajax({
                            type: "POST",
                            async: true,
                            cache: false,
                            data: {'ids': getEnableSalesMangerSelectedIds()},
                            url: "<?php echo site_url('ajax/enableGroupSalesManager'); ?>?" + Math.floor((Math.random() * 100000) + 1),
                            dataType: "JSON"
                        })
                            .success(function (data) {
                                location.href = "/admin";
    ...
    // disabled Group SalesManager

    function disableGroupSalesManager() {
            $("#loading").dialog('open');
            $.ajax({
                            type: "POST",
                            async: true,
                            cache: false,
                            data: {'ids': getEnableSalesMangerSelectedIds()},
                            url: "<?php echo site_url('ajax/disableGroupSalesManager'); ?>?" + Math.floor((Math.random() * 100000) + 1),
                            dataType: "JSON"
                        })
                            .success(function (data) {
                                location.href = "/admin";
    ...
    // enable Group ModifyPrice
            function enableGroupModifyPrice() {
    $("#loading").dialog('open');
            $.ajax({
                            type: "POST",
                            async: true,
                            cache: false,
                            data: {'ids': getEnableSalesMangerSelectedIds()},
                            url: "<?php echo site_url('ajax/enableGroupModifyPrice'); ?>?" + Math.floor((Math.random() * 100000) + 1),
                            dataType: "JSON"
                        })
                            .success(function (data) {
                                location.href = "/admin";
    ...
    //disableGroupModifyPrice

    function disableGroupModifyPrice() {
    $("#loading").dialog('open');
            $.ajax({
                            type: "POST",
                            async: true,
                            cache: false,
                            data: {'ids': getEnableSalesMangerSelectedIds()},
                            url: "<?php echo site_url('ajax/disableGroupModifyPrice'); ?>?" + Math.floor((Math.random() * 100000) + 1),
                            dataType: "JSON"
                        })
                            .success(function (data) {
                                location.href = "/admin";
    ...
    function enableGroupProposalCampaigns() {
    $("#loading").dialog('open');
            $.ajax({
                            type: "POST",
                            async: true,
                            cache: false,
                            data: {'ids': getEnableSalesMangerSelectedIds()},
                            url: "<?php echo site_url('ajax/enableGroupProposalCampaigns'); ?>?" + Math.floor((Math.random() * 100000) + 1),
                            dataType: "JSON"
                        })
                            .success(function (data) {
                                location.href = "/admin";
    ...
    function disableGroupProposalCampaigns() {
    $("#loading").dialog('open');
            $.ajax({
                            type: "POST",
                            async: true,
                            cache: false,
                            data: {'ids': getEnableSalesMangerSelectedIds()},
                            url: "<?php echo site_url('ajax/disableGroupProposalCampaigns'); ?>?" + Math.floor((Math.random() * 100000) + 1),
                            dataType: "JSON"
                        })
                            .success(function (data) {
                                location.href = "/admin";
    ...
    function enableGroupCustomerChecklist() {
    $("#loading").dialog('open');
            $.ajax({
                            type: "POST",
                            async: true,
                            cache: false,
                            data: {'ids': getEnableSalesMangerSelectedIds()},
                            url: "<?php echo site_url('ajax/enableGroupCustomerChecklist'); ?>?" + Math.floor((Math.random() * 100000) + 1),
                            dataType: "JSON"
                        })
                            .success(function (data) {
                                location.href = "/admin";
        ...
        function disableGroupCustomerChecklist() {
            $("#loading").dialog('open');
            $.ajax({
                            type: "POST",
                            async: true,
                            cache: false,
                            data: {'ids': getEnableSalesMangerSelectedIds()},
                            url: "<?php echo site_url('ajax/disableGroupCustomerChecklist'); ?>?" + Math.floor((Math.random() * 100000) + 1),
                            dataType: "JSON"
                        })
                            .success(function (data) {
                                location.href = "/admin";
