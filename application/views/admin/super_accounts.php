                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           // if (!$account->isAdministrator(true)) {
                                ...
                                <a class="btn-delete tiptip" title="Delete" href="<?php echo site_url('admin/delete_master_user/' . $account->getAccountId().'/'.$this->uri->segment(3)) ?>">Delete User</a>
                                <?php //} ?>
                        </td>
                    </tr>
                        <?php
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".btn-delete").click(function() {
            if (!confirm('Are you sure you want to delete this Parent User? They will no longer have access to the system.')) {
                return false;
            }
        });
