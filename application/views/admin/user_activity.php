    ...
    <div class="widthfix">
        ...
        <div class="content-box">
            <div class="box-header">
                User Activity <?php if (!$this->uri->segment(3)) { ?>(global actions.)<?php } else { ?>(<?php echo $company->getCompanyName() ?>)<?php } ?> 
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        <?php $ajaxUrl = ($this->uri->segment(3)) ? 'ajax/admin_history/' . $this->uri->segment(3) : 'ajax/admin_history' ?>
            ...
            hTable = $('.dataTables-history-new').on('error.dt', function (e, settings, techNote, message) {
                ...
                .DataTable({
                    ...
                    "columnDefs": [
                        ...
                        {"targets": [1], "visible": false, "width": '9%'},
                        {"targets": [2], "sortable": true, "width": '9%'},
                        {"targets": [3], "sortable": true, "width": '9%'},
                        {"targets": [4], "sortable": true, "width": '9%'},
                        {"targets": [5], "sortable": true, "width": '9%'},
                        {"targets": [6], "sortable": true, "width": '10%'},
                        {"targets": [7], "sortable": true, "type": "html", "width": '30%'},
                    ],
                    "sorting": [
                        [0, "desc"]
                    ],
        ...
        function applyFilter() {
            ...
            setTimeout(function () {
                ...
                // Created Range
                var hAdminCreatedFrom = $("#hCreatedFrom").val();
                var hAdminCreatedTo = $("#hCreatedTo").val();

                var hAdminActionParent = $("#actionParent").val();
                var hAdminActionChild = $("#actionChild").val();

                $.ajax({
                    type: "POST",
                    url: '<?php echo site_url('ajax/setAdminHistoryFilter') ?>',
                    data: {

                        hAdminFilterFrom: hAdminCreatedFrom,
                        hAdminFilterTo: hAdminCreatedTo,
                        hAdminActionParent: hAdminActionParent,
                        hAdminActionChild: hAdminActionChild,
