...
<div id="content" class="clearfix">
        <div class="widthfix">
<p>
    <span style="font-size:14px;color:#000;font-weight:bold">Editing Estimate Template - <?php echo $template->getName(); ?></span>
    <a href="<?php echo site_url('admin/estimating_templates'); ?>" class="btn blue-button right">
        ...
        <ul>
            <li>
                <a href="#existingItems">
                    <i class="fa fa-fw fa-list"></i> Template Items
                </a>
            </li>
            <li>
                <a href="#allItems">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        allItemsTable = $("#allItemsTable").DataTable({
            ...
            "order": [[3, "asc"]],
            "ajax" : {
                "url": "<?php echo site_url('ajax/adminEstimateItemsLookup/' . $template->getId()); ?>",
                "type": "GET",
                data: function(d) {
                ...
                function() {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json'
                            ...
                            swal("Item Removed from Template");
                            itemsTable.ajax.reload();
                            allItemsTable.ajax.reload();
                        })
                        .fail(function() {
