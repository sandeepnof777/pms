...
<form autocomplete="off" class="form-validated" accept-charset="utf-8" method="post"
      action="<?php echo site_url('admin/saveEstimatingItem') ?>" id="add_item_form" >
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <p class="clearfix left">
                                    ...
                                    <select name="categoryId" id="categoryId" class="required" required>
                        ...
                        <tr>
                            <td>
                                <p class="clearfix left">
                                    <label>Type</label>
                                    <select name="typeId" id="typeId" class="required" required>
        ...
        <div class="box-content">
                ...
                <table width="100%" cellspacing="0" cellpadding="0" class="boxed-table stripping-table">
                    ...
                    <tr>
                        <td>
                            <p class="clearfix left">
                                <label>Tax <span  style="float:right;margin-left: 10px;"><input type="checkbox" id="taxable" name="taxable" class="" tabindex=""></label>
                    ...
                    <!-- <tr style="display: none;" id="taxRateRow">
                        <td>
                            <p class="clearfix left">
                                <label>Tax Rate</label>
                                <input type="text" id="tax_rate" value="0" name="tax_rate" class="text percentFormat" tabindex=""
                                       style="width: 50px;"><span class="tax_amount after_input2">$0.00</span>
                            </p>
                        </td>
                    </tr> -->
                    <tr>
