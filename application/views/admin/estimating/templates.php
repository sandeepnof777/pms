...
<table class="boxed-table defaultTable" width="100%" id="estimationTemplates">
    ...
    <th style="padding: 5px;"> <i class="fa fa-fw fa-sort"></i></th>
        <th style="padding: 10px; text-align: left;">Assembly Name</th>
        <th style="padding: 10px; text-align: left;width:20%">Type</th>
        <th style="padding: 10px; text-align: left;width:10%">Unit</th>
        <th style="padding: 10px; text-align: left;width:10%">Rate</th>
    ...
    <?php foreach ($templates as $template) : ?>
        ...
        <td><span class="span_checkbox"><input type="checkbox" class="template_check" data-template-id="<?php echo $template->getId(); ?>" ></span></td>
            ...
            <td><?php echo $template->getFixed() ? 'Fixed Rate' : 'Standard' ?></td>
            ...
            <td width="20%">
                <?php //if ($template->getCompanyId()) : ?>
                    ...
                    <a href="<?php echo site_url('admin/edit_estimating_template/' . $template->getId()); ?>"
...
<div id="templateNameDialog" title="Save Assembly ">
    ...
    <div style="padding-top: 10px;">
        <form id="saveTemplateForm" action="<?php echo site_url('admin/saveAdminEstimatingTemplate') ?>" method="post">
    ...
    <table class="formTable boxed-table-error">
        ...
        <tr class="templateRateRow">
            ...
            <td>
                <input type="text" class="text currencyFormat" readonly="readonly" name="templateBasePrice" id="templateBasePrice" style="width:60px">
...
$(".duplicateTemplate").click(function() {
        ...
        $(".deleteTemplate").click(function() {
            ...
            swal({
                ...
                function() {
                    window.location.href = '<?php echo site_url('admin/deleteAdminEstimatingTemplate'); ?>/' + templateId;
                }, function (dismiss) {
...
$("#servicesDialog").dialog({
        ...
        $(".assignTemplate").click(function() {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('ajax/getAdminCompanyTemplateServices'); ?>",
                dataType: "JSON"
            })
        ...
        $("#saveAssignments").click(function() {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('ajax/adminCompanyTemplateServiceAssign'); ?>",
                dataType: "JSON"
            })
            .success(function (data) {
                if (!data.error) {
                    ...
                    click: function () {
                        ...
                        $.ajax({
                            ...
                            .success(function (data) {
                                ...
                                if (data.success) {
                                    var deleteText = data.count + ' Assemblies were deleted';
                                }
                                else {
