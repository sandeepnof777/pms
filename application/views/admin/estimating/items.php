...
<div id="content" class="clearfix">
    <div class="widthfix">
        ...
        <h3>
            Estimating Items
            <input type="text" name="itemSearch" id="itemSearch" placeholder="Search Items" />
        </h3>
                            ...
                            <?php foreach ($sortedItems[$category->getId()][$categoryType->getId()] as $typeItem) : ?>
                                ...
                                <tr  id="items_<?php echo $typeItem->getId(); ?>">
                                    ...
                                    <td  width="23%">
                                        ...
                                        <!-- <a href="javascript:void(0);" class="btn tiptip assignTemplate" title="Assign Assembly"
                                            data-item-id="<?php echo $typeItem->getId(); ?>">
 ...
 endforeach; ?>
        ...
        <?php 
    $this->load->view('admin/estimating/item-dialog'); ?>
    ...
    $(document).ready(function() {
        ...
        $("table.estimatingItemsTable tbody").sortable({
            ...
            stop:function () {
                ...
                $.ajax({
                    type:"POST",
                    url:"<?php echo site_url('ajax/updateAdminEstimationItemsCompanyOrder') ?>",
                    data:postData,
                    async:false
                });
            }
        ...
        $(".deleteItem").click(function() {
            ...
            swal({
                ...
                function() {
                    window.location.href = '<?php echo site_url('admin/deleteEstimatingItem'); ?>/' + itemId;
                }, function (dismiss) {
                ...
                "Delete": {
                    ...
                    click: function () {
                        ...
                        $.ajax({
                            ...
                            url: "<?php echo site_url('ajax/adminItemsGroupDelete'); ?>?" + Math.floor((Math.random() * 100000) + 1),
                            dataType: "JSON"
                        })
                            .success(function (data) {
