...
<div id="tableFilterContainer" style="position: relative;">
    ...
    <div class="materialize">
        ...
        <div class="m-btn groupAction tiptip" style="position: relative;float:left;margin-right: 10px;"
            ...
            <div class="groupActionsContainer materialize">
                <div class="collection groupActionItems" id="clientGroupActions">
                    ...
                    <a class="collection-item iconLink changeBusinessType"><i class="fa fa-fw fa-briefcase"></i> Change Business Type</a>
                    ...
                    <a class="collection-item iconLink deleteProspects"><i class="fa fa-fw fa-trash"></i> Delete
                        Prospects</a>
                    <a class="collection-item iconLink" id = "groupProspectsExport"><i class="fa fa-fw fa-cloud-download"></i> Export
                        Prospects</a>
                </div>
            </div>
        </div>
        ...
        <div class="dropdownButton" style="float:right;margin-left: 5px;margin-bottom: 5px;">
                        ...
                        <ul class="dropdownMenu" style="width: 180px">
                            ...
                            <li>
                                <a href="<?php echo site_url('account/upload_data') ?>" style="padding-left:10px;">
                                    <i class="fa fa-fw fa-upload" ></i> Upload Prospects
                                </a>
                                
                            </li>
                            <li>
                                <a href="<?php echo site_url('prospects/map') ?>" style="padding-left:10px;">
                                    <i class="fa fa-fw fa-map" ></i> Map
                                </a>
                                
                            </li>
                            <li style="display: <?=$display;?>;">
                                <a href="<?= site_url('prospects/group_resends'); ?>" id="proposalMapLink" style="padding-left:10px;">
                ...
                <a href="<?=site_url('prospects/group_resends');?>" class="m-btn grey tiptip " style="float:right;margin-left:5px;padding:0px 5px;display:<?= $display; ?>" title="Campaigns "><i class="fa fa-fw fa-envelope"></i> <span class="campaign_count_btn"><?=count($resends);?></span></a>
                <a href="<?= site_url('prospects/add'); ?>" class="m-btn blue-button right" ><i class="fa fa-fw fa-plus"></i>
                Add Prospect</a>
        </div>
    ...
    <div class="newFilterContainer">
        ...
        <?php } ?>
            ...
            <div id="filterInfo">
                ...
                <p id="filterResults" style="height: 18px;"><span id="filterNumResults"></span> Prospects found
                <a class="btn ui-button tiptip" title="Reset All Filters" style="position: absolute;display: inline;font-size: 13px;top: 4px;right: 247px;" id="newResetProspectFilterButton2"><i class="fa fa-fw fa-refresh"></i> Reset</a>
            ...
            <div id="topFilterRow">
                ...
                <div class="filterColumn filterCollapse">
                    ...
                    <?php
                    $allUsers = false;
                    $filterUsers = $this->session->userdata('ptFilterUser') ?: [];

                    if (!count($filterUsers) || (count($filterUsers) == count($accounts))) {
                        $allUsers = true;
                    }

                    $filterBranches = $this->session->userdata('ptFilterBranch') ?: [];
                ...
                <div class="filterColumn filterCollapse">
                    ...
                    <?php
                    $allSources = false;
                    $filterSources = $this->session->userdata('ptFilterSource') ?: [];
                    ...
                    <div class="filterColumnScroll" id="sourceFilterColumn">
                        ...
                        <div class="filterColumnRow sticky" id="sourceRowAll">
                ...
                <div class="filterColumn filterCollapse">
                    ...
                    <?php
                    $allRatings = false;
                    $filterRatings = $this->session->userdata('ptFilterRating') ?: [];
                    ...
                    <div class="filterColumnScroll" id="sourceFilterColumn">
                        ...
                        <div class="filterColumnRow sticky" id="sourceRowAll">
                            <input type="checkbox" id="allRatings" class="filterColumnCheck"
            ...
            <div class="filterRow" style="padding-top: 2px;">            
                ...
                <div class="filterColumn filterCollapse">
                    ...
                    $filterBusinessTypes = $this->session->userdata('ptFilterBusinessType') ?: [];
        ...
        <div class="filterRow" style="margin-top:2px">
            ...
            <label class="checkbox-inline">
                <input type="checkbox" class="column_show" name="column_show" value="11"><span
                        style="margin-top: 3px;position: absolute;">Title</span>
            </label>
            <label class="checkbox-inline">
                <input type="checkbox" class="column_show" name="column_show" value="13"><span
