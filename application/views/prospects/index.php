...
.dataTables-prospects tbody tr.odd.selectedRow,
.dataTables-prospects tbody tr.even.selectedRow,
.dataTables-prospects tbody tr.even.selectedRow td.sorting_1,
.dataTables-prospects tbody tr.odd.selectedRow td.sorting_1
{
    ...
    <div id="content" class="clearfix">
        <div class="widthfix">
            ...
            <?php //$this->load->view('prospects/prospect-filters') ?>
            <?php $this->load->view('templates/prospects/table/filters-new'); ?>
            ...
            <div class="content-box" style="margin-top: 5px;">
                ...
                <div class="box-content" style="width: 950px; overflow-y: scroll; overflow-y: hidden;">
                    <div id="prospectsTableContainer" style="width: 1000px;">
    ...
    <div id="groupExportProspects" title="Select File Name">
        <p>Enter a file name for your export</p>
        <br/>
        <form action="<?php echo site_url('prospects/groupExport');?>" method="post" id="groupExportForm">
        <p><input type="text" id="groupExportName" name="fileName" placeholder="File Name"></p>
        <p><input type="hidden" name="groupExportProspectIds" id="groupExportProspectIds"></p>
        </form>
    </div>
            ...
            <script type="text/javascript">
                ...
                var prospectFilter;
                $(document).ready(function () {
                    if(localStorage.getItem("prospect_column_show_1") == null && localStorage.getItem("prospect_column_show_3") != null){
                        localStorage.setItem("prospect_column_show_1",localStorage.getItem("prospect_column_show_3"));
                    }
                    ...
                    function initTable() {
                        pTable = $('.dataTables-prospects').on('error.dt', function (e, settings, techNote, message) {
                            ...
                            .DataTable({
                                "processing": true,
                                "serverSide": true,
                                "ajax": "<?php echo site_url('prospects/table'); ?>",
                                ...
                                "columnDefs": [
                                    ...
                                    {"targets": [1], "sortable": false, "type": "html", 'class': 'dtCenter', "width": "4%"},
                                    {"targets": [2], "width": '5%',"visible": false},
                                    {"targets": [3],"width": '6%', "sortable": true, "orderData": 2},
                                    
                                    {"targets": [4],"width": '6%', "sortable": true}, //status
                                    {"targets": [5], "visible": false}, //rating num
                                    {"targets": [6], "width": '7%',"sortable": true, "orderData": 5},//rating text
                                    {"targets": [7], "width": '7%',"sortable": false},//business type
                                    {"targets": [8], "width": '7%',"sortable": true},// company name 
                                    {"targets": [9], "visible": false}, // contact 
                                    {"targets": [10],  "width": '8%',"sortable": true, "orderData": 9},// contact html
                                    {"targets": [11],"width": '7%', "sortable": true}, //Title
                                    {"targets": [12], "visible": false},//Owner
                                    {"targets": [13],"width": '5%', "orderData": 11},//Owner html
                                ],
                                "sorting": [
                                    [2, "desc"]
                                ],
                            ...
                            pTable.columns([9]).visible(false);
                            pTable.columns([5]).visible(false);
                        var column_show = localStorage.getItem("prospect_column_show_1");
                        if (column_show) {
                            ...
                            var column_show = [3, 4, 6, 7, 8, 10, 11, 13];
                            pTable.columns(column_show).visible(true);
                            for ($i = 0; $i < column_show.length; $i++) {
                                $("input[name=column_show][value=" + column_show[$i] + "]").prop("checked", true);
                            }
                        ...
                        setTimeout(function () {
                            ...
                            if ($(".sourceFilterCheck:checked").length != $(".sourceFilterCheck").length) {
                                leadSources = $(".sourceFilterCheck:checked").map(function () {
                                    ...
                                    leadSourceNames.push($(this).data('text-value'));
                                    return $(this).val();
                                }).get();
                            } else {
                                leadSources = 'All';
                            ...
                            for($i=0;$i<leadSources.length;$i++){
                                var queryStr = { "id" : leadSourceValues[$i],"name": leadSourceNames[$i]};
                                source_object_array.push(queryStr);
                            }

                            var rating_object_array = [];
                            for($i=0;$i<ratings.length;$i++){
                                var queryStr = { "id" : ratings[$i],"name": ratingsValues[$i]};
                                rating_object_array.push(queryStr);
                            }
                            ...
                            prospectFilter = {
                                ...
                                "ptFilterUserObject": user_object_array,
                                "ptFilterRating": ratingsValues,
                                "ptFilterRatingObject": rating_object_array,
                                "ptFilterSource": leadSourceValues,
                                "ptFilterBranch":selectedBranches,
                                "ptFilterSourceObject": source_object_array,
                                "ptFilterBusinessType": leadBusinessTypeValues,
                                "ptFilterBusinessTypeObject": business_type_object_array,
                                
                            }

                            $.ajax({
                                type: "POST",
                                url: '<?php echo site_url('ajax/setProspectFilter') ?>',
                                data: {
                                    ...
                                    ptFilterBusinessType: leadBusinessTypes,
                                ...
                                swal({
                                        ...
                                        html:  notes_content,
                                            ...
                                            onOpen:  function() {
                                                ...
                                                $('.swal2-modal').attr('id','prospect_notes_popup');
                            ...
                            Save: {
                                ...
                                click: function () {
                                    ...
                                    $.ajax({
                                        ...
                                        url: "<?php echo site_url('ajax/groupProspectsChangeBusinessTypes') ?>?" + Math.floor((Math.random() * 100000) + 1),
                                        dataType: "JSON"
                                    }).success(function (data) {
...
//                     var rating = $("#filterRatingValue").val();
//                     var source = $("#filterSourceValue").val();
// //        alert('Branch: ' + branch + ' | User: ' + user + ' | Status: ' + status + ' | Rating: ' + rating);
//                     $.ajax({
//                         type: "POST",
//                         url: '<?php echo site_url('ajax/setProspectFilter') ?>',
//                         data: {
//                             ptFilterUser: user,
//                             ptFilterBranch: branch,
//                             ptFilterStatus: status,
//                             ptFilterRating: rating,
//                             ptFilterSource: source
//                         },
//                         dataType: 'JSON',
//                         success: function () {
//                             setTimeout(function () {
...
//                 }
                    ...
                    $('.column_show_apply').click(function () {
                        ...
                        pTable.columns([3, 4, 6, 7, 8, 10, 11, 13]).visible(false);
                        var favorite = [];
                        ...
                        if(hasLocalStorage){
                            localStorage.setItem("prospect_column_show_1", favorite);
                        }
...
$(document).on('click', '#dataTables-prospects tbody td a, #dataTables-prospects tbody td span',  function() {
    $('tr.selectedRow').removeClass('selectedRow');
    $(this).parents('tr').addClass('selectedRow');
    var row_num = $(this).closest('tr').find('td:eq(0) input[type="checkbox"]').attr('data-prospect-id');
    if(hasLocalStorage){
        localStorage.setItem("ps_last_active_row", row_num);
    }
...
$(document).on('click', '.javascript_loaded',  function(e) {
    $('tr.selectedRow').removeClass('selectedRow');
    if(hasLocalStorage){
        localStorage.setItem("ps_last_active_row", '');
    }
});
...
$("#saves_filter_list").change(function() {
        ...
        setTimeout(function() {
                ...
                $.each(filter, function(key,value) {
                    if(key=='ptFilterBusinessTypeObject'){
                        $('.businessTypeFilterCheck').prop('checked', false);
                    ...
                    else if(key=='ptFilterUserObject'){
                        $('.userFilterCheck').prop('checked', false);
                        $('#allUsersCheck').prop('checked', false);
                        for($i=0;$i<value.length;$i++){
                     ...
                     else if(key=='ptFilterSourceObject'){
                        $('.sourceFilterCheck').prop('checked', false);
                        $('#allSources').prop('checked', false);
                        for($i=0;$i<value.length;$i++){
                            $('.sourceFilterCheck[value="' + value[$i].name +'"]').prop('checked', true);
                        }
                         
                     }else if(key=='ptFilterRatingObject'){
                        $('.ratingFilterCheck').prop('checked', false);
                        $('#allRatings').prop('checked', false);
                        for($i=0;$i<value.length;$i++){
                            $('.ratingFilterCheck[value="' + value[$i].id +'"]').prop('checked', true);
                        }
...
$(document).on("keyup","#swal-input1",function(e) {
    ...
    if($(this).val()){
        $.ajax({
                        ...
                        type: 'POST',
                        dataType: 'json',
                        data: {name:$('#swal-input1').val(),type:'Prospect'},
                        success: function (response) {
                            if(response.success == true)
                            {
                               $('#nameExist').html("Filter Name Alredy Exist!"); 
        ...
        // Export Menu Button
        $("#groupProspectsExport").click(function() {
           
            // Clear the input
            $("#groupExportName").val('');
            // Store Selected ids in hidden field
            $('#groupExportProspectIds').val(getSelectedIds());
            // Open the dialog
           $("#groupExportProspects").dialog('open');
           $('.groupActionsContainer').hide();
        });

        // Group Export dialog
        $("#groupExportProspects").dialog({
            modal: true,
            autoOpen: false,
            buttons: {
                "Export": {
...
// internal filter reset button
$("#newResetProspectFilterButton2").click(function () {
    ...
    $(document).on("click",".reload_history_table",function(e) {
        hTable.ajax.reload(null,false )
                    ...
                    $(document).on("click", ".email_event_email_show_span", function (e) {
                        ...
                        tinymce.init({selector: "#event_email_content",menubar: false,relative_urls : false,remove_script_host : false,convert_urls : true,statusbar: false,toolbar : false,height:'300',readonly : true});
    ...
    function get_prospect_resend_lists(){

        $.ajax({
            url: '<?php echo site_url('ajax/get_prospect_resend_lists') ?>',
            type: "GET",
...
<div class="javascript_loaded">
            <div id="notes" title="Notes" style="display: none;">
                ...
                <div id="change-business-type" title="Change Prospect Business Type">
                    <p>Choose one or many Business Types to assign to the selected  <span id="changeBusinessTypeNum"></span> prospects</p><br/>
