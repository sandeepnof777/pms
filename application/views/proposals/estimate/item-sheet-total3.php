...
table td {
    ...
    <div id="content" class="clearfix estimate-item-sheet materialize" xmlns="http://www.w3.org/1999/html">
        ...
        <a href="<?php echo site_url('pdf/live2/download/item-sheet-total/'. $proposal->getAccessKey() . '.pdf'); ?>" class="btn right">
                Download
        </a>
        <a href="<?php echo site_url('proposals/estimate_items_total/' . $proposal->getProposalId()); ?>" class="btn right blue-button">
                Items Total
        </a>
        <a href="<?php echo site_url('proposals/estimate_items/' . $proposal->getProposalId()); ?>" class="btn right">
                Items Breakdown
        </a>
