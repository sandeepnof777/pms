...
<table style="float:left;width:100%;font-size:16px">
    <tr><th colspan="2"><span style="text-align: center;margin-bottom:2px">Images Viewed</span></th></tr>
<?php
        ...
        foreach ($imageViewData as $s => $imageData) {
            ...
            if ($image) {
                ...
                <div align="center" class="img-container center"
                     style="float:left;width:100%;padding-right: 0px;padding-left: 0px;padding-top: 2px;padding-bottom: 2px;margin-top:5px;margin-bottom:5px;">
                    <!--[if mso]>
