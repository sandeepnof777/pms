...
.jobCostItems a.btn:hover{
    color:#FFF;
}
a.btn span {
    color: #FFF;
}
.collapsible-header{padding: 0.4rem;}
</style>
<div id="content" style="width:966px" class="clearfix estimate-item-sheet " xmlns="http://www.w3.org/1999/html">
    ...
    <div class=" clearfix relative">
        ...
        <div id="project-details" class="row materialize">
...
foreach ($services as $service):
    ...
    ?>
			            ...
			            <li>
                            ...
                            <a href="javascript:void(0);" class="add_item_btn btn blue-button col s2" style="margin-left:auto;float: none;font-weight:100" data-val="<?=$service_details->getServiceId();?>" ><i class="material-icons">add_circle</i> <span style="position: relative;top: -5px;"> Add Item</span></a>
			                <?php
...
if (isset($serviceSortedItem['items'])) {
        foreach ($serviceSortedItem['items'] as $breaklineItem):
            ...
            ?>
			                                                        ...
			                                                        <tr class="header_tr header_tr_border <?=($breaklineItem->job_cost) ? 'has_item_value' : '';?>" data-item-id="<?=$breaklineItem->getId();?>"  id="tr_line_item_<?=$breaklineItem->getId();?>" data-unit-price="<?=$breaklineItem->getUnitPrice();?>" data-total-price="<?=$breaklineItem->old_total;?>" data-proposal-service-id="<?=$breaklineItem->getProposalServiceId();?>" data-quantity="<?=$breaklineItem->getQuantity();?>" data-day="<?=$breaklineItem->getDay();?>" data-hpd="<?=$breaklineItem->getHoursPerDay();?>" data-num-people="<?=$breaklineItem->getNumPeople();?>" data-base-price="<?=$breaklineItem->getBasePrice();?>" data-old-quantity="<?=$breaklineItem->old_quantity;?>" data-category-id="<?=$breaklineItem->getItemType()->getCategoryId();?>" data-val='<?php echo $saved_values; ?>'>
			                                                            ...
			                                                            <td width="35%" style="text-align:left;"><?php
    ...
    if ($serviceSortedItem['category']->getId() == \models\EstimationCategory::CUSTOM) {
            ...
            ?>
                                                                        ...
                                                                        <?php 
                                                                        if ($breaklineItem->getItemType()->getId() == \models\EstimationType::CONCRETE) {
                                                                            ?>
                                                                            <span class="span_disposal_load tr_edit_span mg-r-10"><input class="input_disposal_load tr_edit_input number_field" style="width: 60px; font-weight: bold; text-align: right;height: 20px !important;font-size: 18px !important;" onselectionchange="return false" type="text" value="<?php echo trimmedQuantity($breaklineItem->getDisposalLoads()); ?>"> Loads</span>

                                                                        
                                                                        <?php } ?>
                                                                        <span class="span_quantity tr_edit_span"><input class="input_quantity tr_edit_input number_field" style="width: 60px; font-weight: bold; text-align: right;height: 20px !important;font-size: 18px !important;" onselectionchange="return false" type="text" value="<?php echo trimmedQuantity($breaklineItem->getQuantity()); ?>">
			                                                                <?php echo $breaklineItem->getItem()->getUnitModel()->getAbbr(); ?> </span>
			                                                            </td>


			                                                            <td width="20%" style="padding: 3px;"><a href="javascript:void(0);" style="float: right;margin-left: 10px;background-color:red; <?=($breaklineItem->job_cost) ? '' : 'display:none';?>" class="btn tr_delete_btn tiptip tr_action_btn"   title="Delete"  ><i class="material-icons">delete</i></a><span><a href="javascript:void(0);" style="float: right;margin-left: 2px;" class="btn tr_save_btn tiptip tr_action_btn"   title="Save"  ><i class="material-icons">save</i></a></span></td>
    ...
    if ($serviceSortedItem['category']->getId() != 1) {
                if ($check_type) {
                    ...
                    echo '<td colspan="4"><span style="display: inline-block;width: 33%;"><b>Days:</b> <input value="' . str_replace('.00', '', number_format($breaklineItem->getDay(), 2, '.', ',')) . '" class="input_day tr_edit_input number_field" type="text"  style="width: 50px;font-size: 18px !important;    font-weight: bold;"></span><span style="display: inline-block;width: 33%;"><b>#:</b> <input value="' . str_replace('.00', '', number_format($breaklineItem->getNumPeople(), 2, '.', ',')) . '" class="input_num_people tr_edit_input number_field" type="text"  style="width: 50px;font-weight: bold;font-size: 18px !important;"></span><span style="display: inline-block;width: 33%;"><b>HPD:</b> <input value="' . str_replace('.00', '', number_format($breaklineItem->getHoursPerDay(), 2, '.', ',')) . '" class="input_hpd tr_edit_input number_field" type="text" style="width: 70px;font-weight: bold;font-size: 18px !important;" ></span></td>';
                } else {
...
if (isset($serviceSortedItem['job_cost_items'])) {
        ...
        ?>
                                                        ...
                                                        <td width="5%" style="padding: 5px;"><span class="open_row tiptip" title="Details" style="float:right"><i class="fa fa-fw fa-1x fa-chevron-right  " style="cursor:pointer;"></i></span></td>
                                                            <td width="40%" style="text-align:left;"><b>Job Cost Item</b>
                                                            </br>
                                                            ...
                                                            <td width="20%" style="padding: 3px;"><a href="javascript:void(0);" style="float: right;margin-left: 10px;background-color:red" class="btn tr_job_item_delete_btn tiptip tr_action_btn"   title="Delete"  ><i class="material-icons">delete</i></a><span><a href="javascript:void(0);" style="float: right;margin-left: 2px;" class="btn tr_job_item_save_btn tiptip tr_action_btn"   title="Save"  ><i class="material-icons">save</i></a></span></td>
                                                        </tr>
                                                        <tr>
                                                        <th width="5%"></th>
...
if (isset($serviceSortedItem['items'])) {
    ...
    //print_r($breaklineItem);die;
            ...
            ?>
	                                                                ...
	                                                                <td width="5%"></td>
	                                                                <td width="30%" style="text-align:right;"><span class="span_quantity tr_edit_span"><input class="input_quantity tr_edit_input number_field" style="width: 60px; text-align: right;height: 20px !important;font-size: 18px !important;font-weight: bold;" type="text" value="<?php echo trimmedQuantity($breaklineItem->getQuantity()); ?>">
	                                                                    <?php echo $breaklineItem->getItem()->getUnitModel()->getAbbr(); ?>
	                                                                </td>
            ...
            if ($check_type) {
                ...
                echo '<td colspan="4"><span style="display: inline-block;width: 33%;"><b>Days:</b> <input value="' . str_replace('.00', '', number_format($breaklineItem->getDay(), 2, '.', ',')) . '" class="input_day tr_edit_input number_field" type="text"  style="width: 50px;font-size: 18px !important;font-weight: bold;"></span><span style="display: inline-block;width: 33%;"><b>#:</b> <input value="' . str_replace('.00', '', number_format($breaklineItem->getNumPeople(), 2, '.', ',')) . '" class="input_num_people tr_edit_input number_field" type="text"  style="font-weight: bold;width: 50px;font-size: 18px !important;"></span><span style="display: inline-block;width: 33%;"><b>HPD:</b> <input value="' . str_replace('.00', '', number_format($breaklineItem->getHoursPerDay(), 2, '.', ',')) . '" class="input_hpd tr_edit_input number_field" type="text" style="font-weight: bold;width: 70px;font-size: 18px !important;" ></span></td>';
            } else {
                echo '<td></td><td></td><td></td>';
            }
...
if (count($service['subContractorItem']) > 0) {
    ...
    foreach($breaksortedItems as $breaksortedItem): ?>
                                                ...
                                                <table class="jobCostItems " class="" style="width: 100%;">
...
?>
                <li>
                    <div class="collapsible-header" style="align-items: center;"><i class="material-icons  expand">expand_less</i><span style="max-width:70%">Attachments</span></div>
    ...
    <div class="row">
        <ul class="collapsible collapsible_complete_parent">
                <li>
                    ...
                    <div class="collapsible-body row" >
                    <form method="post" id="complete_job_cost_form" action="/ajax/completeJobCosting/<?php echo $proposal->getProposalId(); ?>">
                                ...
                                <div class="custom_name" style="margin-top:10px; <?php echo ($proposal->getJobCostForemenId() == '-1') ? 'display:block':'display:none';?>">
                                    ...
                                    <input type="text "  class="tr_edit_input custom_name" name="name" value="<?php echo $proposal->getJobCostUsername();?>">
                                ...
                                <div>
                                    <input type="submit" id="complete_job_cost_btn" class="btn blue-button " value="Complete Job Costing" style="float:right;margin-top:20px;padding: 0px 10px;">
                                </div>
...
function reset_dropdowns(){
    ...
    $(document).on('click', '.tr_save_btn', function() {
        ...
        var disposal_load = $(this).closest('tr').find('.input_disposal_load').val();
        disposal_load = (disposal_load)?cleanNumber(disposal_load):'';
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                tr_row.find('.tr_delete_btn').show();
                //tr_row.find('.open_row').click();
                if(parseFloat(data.service_price_diff)<0){
                    var service_price_diff = '-$'+addCommas(number_test2(Math.abs(data.service_price_diff)));
                }else{
    ...
    $(document).on('keyup', '.input_quantity', function(event) {
        ...
        if(keycode == '13'){
            $(this).closest('tr').find('.tr_save_btn ').click();
        }
    });
   ...
   function trigger_number_mask(){
    ...
    swal({
                    title: "Add Item",
                    html: '<form id="add_job_cost_item_form" action="<?php echo site_url('ajax/save_job_cost_item'); ?>" method="post">'+
                        ...
                        '<table class="boxed-table pl-striped" width="100%" cellpadding="0" cellspacing="0">'+
                            ...
                            '<tr ><td><label for="" style="width: 70px;"> Quantity</label><input type="text" name="job_cost_item_quantity" placeholder="Enter Item Quantity" class="text  job_cost_item_quantity number_field"   value=""></td></tr>'+

                            '<tr><td><label for="" style="width: 70px;">Total Price</label><input type="text" name="job_cost_item_total" placeholder="Enter Item Total Price" class="text  job_cost_item_total currency_field"  value=""></td>'+
                            '</tr></table></form>',
