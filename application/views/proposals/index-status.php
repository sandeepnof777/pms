...
#filterListNew ul li:hover > .created_badge {  width: 52px; }
            ...
            <div class="clearfix">
                ...
                <div id="filterListNew">
                    ...
                    <ul>
                        ...
                        <?php
                            // Created Dates
                            if ($this->session->userdata('pStatusFilterFrom') && $this->uri->segment(3) !='sold') { ?>
                            <li><span  class="badge-icon" ><i class="fa fa-fw fa-calendar"></i></span>
                                ...
                                <strong><?php 
                                    if($created_preset && $created_preset !='custom'){
                                        ...
                                        echo $this->session->userdata('pStatusFilterFrom') .' - '. $this->session->userdata('pStatusFilterTo'); ?>
                                    <?php }?>    
                                </strong>
                        ...
                        <?php if ($this->session->userdata('pStatusFilterUser')) { ?>
                            <li><span class="badge-icon"><i class="fa fa-fw fa-user"></i></span>
                                ...
                                <strong><?php echo $this->session->userdata('pStatusFilterUserName'); ?></strong></li>
                            
                        <?php } ?>
                        <?php if ($this->session->userdata('pStatusFilterStatusName')) { ?>
                            <li><span class="badge-icon"><i class="fa fa-fw fa-bar-chart"></i></span>
                                <span class="rightbox status_badge">
                                    <span class="badge_content"><strong><?=($this->session->userdata('pEmailOff')) ? 'Email: ' :'Status: ';?></strong></span>
                                </span>
                                <strong><?php echo $this->session->userdata('pStatusFilterStatusName'); ?></strong></li>
                        <?php } ?>
                    ...
                    <?php
                        // Nested ternary, sorry
                        if ($this->session->userdata('pStatusFilterChangeFrom') && $this->uri->segment(3) =='sold') { ?>
                        <li><span class="badge-icon"><i class="fa fa-fw fa-calendar"></i></span>
                        <strong>
                        <?php if($this->session->userdata('pStatusFilterStatusName')){
                            echo $this->session->userdata('pStatusFilterStatusName');
                        } else {
                            echo ($this->session->userdata('pSold')) ? 'Sold: ' :'Current Status: ';
                        } ?> 
                            <strong>
                            
                                <?php 
                                    if($sold_preset && $sold_preset !='custom'){
                                        echo $sold_preset;
                                    }else{
                                        echo $this->session->userdata('pStatusFilterChangeFrom') .' - '. $this->session->userdata('pStatusFilterChangeTo'); ?>
                                <?php }?> 
                    ...
                    <?php } ?>
                        ...
                        <?php if ($this->session->userdata('pStatusFilterBranch') || $this->session->userdata('pStatusFilterBranch') === '0') { ?>
                            <li><span class="badge-icon"><i class="fa fa-fw fa-user"></i></span><strong><?php echo $this->session->userdata('pStatusFilterBranchName'); ?></strong></li>
                        <?php } ?>
                    </ul>
                </div>

        <div id="" style="float: left;width: 100%;margin-top:5px">
            <div class="clearfix">
                <?php
            ...
            <input type="hidden" name="filterStatusValue" id="statusFilterStatusValue"
                   value="<?php echo $this->session->userdata('pStatusFilterStatus'); ?>"/>
            <input type="hidden" name="filterQueueValue" id="statusFilterQueueValue"
                   value="<?php echo $this->session->userdata('pStatusFilterQueue'); ?>"/>
            <input type="hidden" name="filterUserValue" id="statusFilterUserValue"
                   value="<?php echo $this->session->userdata('pStatusFilterUser'); ?>"/>
            <input type="hidden" id="filterBranchValue" name="statusFilterBranchValue"
                   value="<?php echo $this->session->userdata('pStatusFilterBranch') ?>"/>
            <input type="hidden" id="filterServiceValue" name="statusFilterServiceValue"
                   value="<?php echo $this->session->userdata('pStatusFilterService') ?>"/>
            <input type="hidden" id="filterServiceFrom" name="statusFilterServiceFrom"
                   value="<?php echo $this->session->userdata('pStatusFilterFrom') ?>"/>
            <input type="hidden" id="filterServiceTo" name="statusFilterServiceTo"
                   value="<?php echo $this->session->userdata('pStatusFilterTo') ?>"/>
            <input type="hidden" id="filterServiceChangeFrom" name="statusFilterServiceChangeFrom"
                   value="<?php echo $this->session->userdata('pStatusFilterChangeFrom') ?>"/>
            <input type="hidden" id="filterServiceChangeTo" name="statusFilterServiceChangeTo"
                   value="<?php echo $this->session->userdata('pStatusFilterChangeTo') ?>"/>
            <input type="hidden" id="group" value="<?php echo $group; ?>"/>
            <input type="hidden" id="action" value="<?php echo $action; ?>"/>
            <input type="hidden" id="pageAction" value="<?php echo $statusAction; ?>"/>
...
//        updateBranchUsers();
                ...
                var user = '<?=$this->session->userdata('pStatusFilterUser');?>';
                if(user !=''){
                ...
                var statusFrom  = '<?= $this->session->userdata('pStatusFilterFrom');?>';
                if(statusFrom!=''){
                ...
                var statusName  = '<?= $this->session->userdata('pStatusFilterStatusName');?>';
                var statusNameShow  = '<?= $this->session->userdata('pStatusFilterStatusNameShow');?>';
                if(segment !='emailoff'){
                    if(statusNameShow !='' ||  statusName !='' || segment !='all' ){
    ...
    <div class="javascript_loaded">
        ...
        <div id="resend-proposals" title="Confirmation">
            ...
            <p>This will send a total of <strong><span id="resendNum"></span></strong> email(s) to their respective
                contact.</p>
            <br/>
