            ...
            <div class="groupActionsContainer materialize">
                <div class="collection groupActionItems" id="clientGroupActions">
                    ...
                    <a class="collection-item iconLink deleteLeads" href="#"><i class="fa fa-fw fa-times-circle"></i>
                        Cancel Leads</a>
                    <a class="collection-item iconLink" id = "groupLeadsExport" href="#"><i class="fa fa-fw fa-cloud-download"></i>
                        Export Leads</a>
                </div>
            </div>
        </div>
                ...
                <div class="dropdownButton" style="float:right;margin-left: 5px;margin-bottom:5px;">
                    ...
                    <div class="dropdownMenuContainer openAbove" style="display: none;width: 180px; left:-112px">
                        ...
                        <ul class="dropdownMenu" style="width: 180px">
                            ...
                            <li>
                                <a href="<?= site_url('account/upload_data'); ?>" style="padding-left:10px;">
                                    <i class="fa fa-fw fa-upload"></i> Upload Leads
                                </a>
    ...
    <div class="newFilterContainer">
        ...
        <?php } ?>
            ...
            <div id="filterInfo">
                ...
                <p id="filterResults" style="height: 18px;"><span id="filterNumResults"></span> leads found

                <a class="btn ui-button tiptip" title="Reset All Filters" style="position: absolute;display: inline;font-size: 13px;top: 4px;right: 245px;" id="newResetleadFilterButton2"><i class="fa fa-fw fa-refresh"></i> Reset</a>
            ...
            <div id="topFilterRow">
                        ...
                        <div class="filterColumnRowContent">
                            <p>
                                ...
                                <input type="text" id="lCreatedFrom" class="text" style="margin-left: 11px;"
                                       value="<?php echo ($this->session->userdata('lFilterDateStart')) ? date('m/d/Y', $this->session->userdata('lFilterDateStart')) : '' ?>">
                                <label>To:</label>
                                <input type="text" class="text" id="lCreatedTo"
                                       value="<?php echo ($this->session->userdata('lFilterDateEnd')) ? date('m/d/Y', $this->session->userdata('lFilterDateEnd')) : '' ?>">
                ...
                <div class="filterColumn filterCollapse" style="width: 33%;">
                    ...
                    <?php
                    $allUsers = false;
                    $filterUsers = $this->session->userdata('lFilterUser') ?: [];

                    if (!count($filterUsers) || (count($filterUsers) == count($accounts))) {
                        $allUsers = true;
                    }

                    $filterBranches = $this->session->userdata('lFilterBranch') ?: [];
                ...
                <div class="filterColumn filterCollapse" style="width: 33%;">
                    ...
                    <?php
                    $allSources = false;
                    $filterSources = $this->session->userdata('lFilterSource') ?: [];
            ...
            <div class="filterRow" style="padding-top: 2px;">
                ...
                <div class="filterColumn filterCollapse" style="width: 33%;">
                    ...
                    <?php
                    $allStatuses = false;
                    $filterStatuses = $this->session->userdata('lFilterStatus') ?: [];
                ...
                <div class="filterColumn filterCollapse">
                    ...
                    <?php
                $allDueDates = false;
                $filterDueDates = $this->session->userdata('lDueDate') ?: [];
