...
<head>
    ...
    <style type="text/css">
        ...
        .image-section-info i, .image-note-section-info i {
            margin-top: 4px;
        }
            ...
            <div class="flex-shrink-0 p-3 bg-white sticky-sidebar scrollbar-primary">
                ...
                <ul class="list-unstyled ps-0 list-group-striped">
                    ...
                    if ($proposal_intro_video) { ?>
                     <li class="mb-1"><a href="#intro_video" class="btn sep-link align-items-center rounded">
                ...
                <?php } ?>
                    ...
                    <?php 
                    if (count($map_images)) { ?>
                        <li class="mb-1"><a href="#map_images"
            ...
            <div class="doc-section" id="doc-section">
                ...
                <?php if ($template == 'web-cool' || $template == 'web-custom') {
                    if ($template == 'web-cool') {
                        ?>
                        <div class="grid invoice page_break no-header-element pdf-height mg-left-55 "
                             data-page-id="cover">
                            <div class="grid-body">
                                <div class="invoice-title avoid-break" id="title-page">
                                    <div class="row">
                    ...
                    <?php } else {
                        ?>
                        <div class="grid invoice page_break no-header-element pdf-height mg-left-55 custom-background"
            ...
            <?php
                        ...
                        foreach ($images2 as $image) {
                            ...
                            switch ($image['image_layout']) {
                                case 1:
                                    ...
                                    if (!($imageCount % 2)) {
                                        ?>
                                        <div class="grid invoice pdf-height page_break 1con mg-left-55" data-page-id="images" style="padding-top: 10px;" <?php //if($j==1){echo ' id="images"';}?> >
                                        <div class="grid-body">
                                        <?php if ($j == 1) { ?>
                                            <div class="row ">
                                                <div class="row">
                                ...
                                default: //1 image per page
                                    ...
                                    ?>
                                    <div class="grid invoice pdf-height page_break 1con mg-left-55"
                                         data-page-id="images"
                ...
                if ($havetexts) { ?>
                    ...
                    <div class="grid invoice pdf-height page_break page_break_before mg-left-55"
                         ...
                         style="padding-top: 10px;" data-page-id="terms">
                        <div class="grid-body">
                            <div class="row">
