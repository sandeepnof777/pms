...
<body>
	...
	<div class="container-fluid">
		<button type="button" class="btn btn-dark openbtn" aria-label="Close"><i class="fa fa-chevron-left sidebar-btn-icon"></i></button>
		<div class="row">
					...
					<div class="grid-body">
						<div class="row">
							...
							<div class="col-lg-3 col-md-6 pd-t-10">
								...
								<span class="second_line"><?php echo $proposal->getProjectAddress() ?><?php echo $proposal->getProjectCity() . ', ' . $proposal->getProjectState() . ' ' . $proposal->getProjectZip() ?></span>
							</div>
			...
			<div class=" doc-section" style="margin-top:15px">
				...
				<div class="grid invoice page_break no-header-element pdf-height" id="title-page">
					<div class="grid-body">
                        <div class="row">
                            <div class="col-md-6">
                                <p>
				...
				if (count($images)) { ?>
					...
					<div class="grid invoice pdf-height page_break" style="padding-top: 10px;" id="images">
						<div class="grid-body">
							<div class="row">
								...
								<?php } else { ?>
									<div class="embed-responsive embed-responsive-16by9 video">
										<?php if ($proposal->getThumbImageURL()) { ?>
											<img src="<?= $proposal->getThumbImageURL(); ?>">
					...
					<div class="grid-body">
						...
						<div class="row">
							...
							<div style="page-break-inside: avoid">
								...
								<table border="0" class="mg-l-11 mg-t-11">
									<tr>
