...
<table border="0">
    <tr>
        <td width="30">Date:</td>
        <td width="182" style="border-bottom: 1px solid #000;">&nbsp;
        <?php    if(isset($clientSignature) && ($clientSignature)){echo date('m/d/Y', strtotime($clientSignature->getCreatedAt())); }?>
    </td>
    </tr>
</table>
        ...
        <td valign="top" width="220" style="line-height: 1.3">
           ...
           if ($clientSignature) {
            ...
            if (isset($clientSignature) && ($clientSignature)) {
                echo '<br>';
                ?>
                <span id="signed_span">Signed :<?php echo  date('m/d/Y g:i A', strtotime($clientSignature->getCreatedAt()) + TIMEZONE_OFFSET); ?>
