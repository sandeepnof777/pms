...
<a class="btn-zoom zoom"  data-container="body" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom In" ><i class="fa fa-plus"></i></a>
<a class="btn-zoom zoom-out" data-container="body" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom Out"><i class="fa fa-minus"></i></a>
<a class="btn-zoom zoom-init" data-container="body" data-bs-toggle="tooltip" data-bs-placement="left" title="Reset Zoom"><i class="fa fa-undo"></i></a>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<nav class="col-md-3 nav " id="navbar-example3">
				...
				<div class="flex-shrink-0 p-3 bg-white sticky-sidebar scrollbar-primary">
					...
					<ul class="list-unstyled ps-0 list-group-striped">
						<li class="mb-1"><a href="#title-page" class="btn sep-link align-items-center rounded">
                                <i class="fa fa-fw fa-file-o"></i>&nbsp;&nbsp;Cover Page</a>
                        </li>
						<li class="mb-1"><a href="#service-provider" class="btn sep-link align-items-center rounded">
                                <i class="fa fa-fw fa-file-text-o"></i>&nbsp;&nbsp;Service Provider Information</a>
                        </li>
						<li class="mb-1"><a href="#about-us-page" class="btn sep-link align-items-center rounded">
                                <i class="fa fa-fw fa-id-card-o"></i>&nbsp;&nbsp;About Us</a></li>
						<?php
						...
						<li class="mb-1 ">
							<button class="btn btn-toggle align-items-center rounded collapsed" data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="false">
                                <i class="fa fa-fw fa-list"></i>&nbsp;&nbsp;Proposal Services
							</button>
							<div class="collapse" id="home-collapse">
								<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
									<?php foreach ($services as $service) { ?>
										<li><a href="#service_<?= $service->getServiceId(); ?>" class="btn sep-link rounded inline-block"><?php echo $service->getServiceName(); if ($service->isOptional()) { ?><span class="badge rounded-pill bg-info pull-right" data-container="body" data-bs-toggle="tooltip" data-bs-placement="right" title="Optional Service">OS</span><?php } ?></a></li>
									<?php } ?>
						...
						<?php if (count($images)) { ?>
							<li class="mb-1"><a href="#images" class="image_section_btn btn sep-link align-items-center rounded">
						...
						?>
							...
							<li class="mb-1"><a href="#video" class="video_section_btn btn sep-link align-items-center rounded">
						...
						<li class="mb-1"><a href="#signature" class="btn sep-link align-items-center rounded">
                                <i class="fa fa-fw fa-money"></i>&nbsp;&nbsp;Payment Terms</a></li>
									...
									foreach ($images2 as $image) {
										...
										switch ($image['image_layout']) {
											...
											//}
												...
												if ($imageCount % 4 == 0) {
													?>
													</div></div><div class="row page_number">Page <?=$page++;?></div></div>
													<?php
													$tableOpen = 0;
												}
												break;
								...
								<?php } else { ?>
									<div class="embed-responsive embed-responsive-16by9 video">
										<?php if ($proposal->getThumbImageURL()) { 
											...
											?>
											<img src="<?= $thumbImageURL; ?>" style="padding-left:10px;padding-right:12px">
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td  <?php if ($k % 2) {
															echo 'class="odd"';
														} ?> ><a href="javascript:void(0)" class="serviceNameList" data-service-optional="0" data-bs-toggle="offcanvas" data-bs-target="#serviceOffcanvasRight" aria-controls="offcanvasRight" data-service-id="service_<?php echo $service->getServiceId() ?>" data-map-area="<?php if ($isMapDataAdded) {  echo $service->getMapAreaData();} ?>"> <?php
																if ($taxprice > 0) {
											...
											<tbody>
												...
												?>
													<tr>
														...
														<td  <?php if ($k % 2) {
															echo 'class="odd"';
														} ?> ><a href="javascript:void(0)" class="serviceNameList" data-service-optional="1" data-bs-toggle="offcanvas" data-bs-target="#serviceOffcanvasRight" aria-controls="offcanvasRight" data-service-id="service_<?php echo $service->getServiceId() ?>" data-map-area="<?php if ($isMapDataAdded) {  echo $service->getMapAreaData();} ?>"> <?php
																if ($taxprice > 0) {
																	echo '<span style="font-weight:bold;vertical-align: sub;">* </span>';
																	$isTaxApplied = true;
																}
			...
			if (count($attachments) || count($proposal_attachments)) {
				?>
				<div class="grid invoice pdf-height" id="attachments">
					<div class="grid-body">
						<h1 class="underlined header_fix attachmentsHead" style="margin-bottom:40px; z-index: 200; margin-left: 0;">Attachments</h1>
						...
						if (count($attachments)) {
							...
							foreach ($attachments as $attachment) {
								$url = site_url('attachments/' . $proposal->getClient()->getCompany()->getCompanyId()) . '/' . $attachment->getFilePath();
								?>
								<h3 class="attachmentName"><a href="<?php echo str_replace(' ', '%20', $url) ?>" target="_blank"><?php echo $attachment->getFileName() ?></a></h3>
							<?php
							} ?>
							</div>
						<?php }
		...
		<?php	}
						...
						<div class="carousel-inner" style="width:100%;">
							...
							foreach ($images2 as $image) { ?>
								<div class="carousel-item pd-top-25 slide-image-<?= $k; ?>">
									...
									<img src="<?php echo $image['src']; ?>" style=" object-fit: contain;height:calc(100vh - 200px)" class="d-block w-100 responsive"  alt="...">
			...
			<!-- end ask question offcanvas-->
			<!-- Service offcanvas-->
			<div class="offcanvas offcanvas-end offcanvas-410" tabindex="-1" id="serviceOffcanvasRight" aria-labelledby="offcanvasRightLabel">
				<div class="offcanvas-header">
					<legend class="text-left pave-text-color ServiceNameHead">Proposal Service</legend>
					<button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
				</div>
