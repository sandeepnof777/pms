...
<div class="issuedby">
    <p class="clearfix" style="line-height: 16px;">
        <img class="theLogo" src="<?php echo UPLOADPATH . '/clients/logos/' . $proposal->getClient()->getCompany()->getCompanyLogo() ?>" alt="" width="145" height="45"><br>
...
<div id="item_<?php echo $k ?>" style="page-break-inside: avoid">
    <div class="item-content">
        ...
        <p style="padding-left: 40px;">Total Price for this item: $<?php echo number_format(intval(str_replace($s, $r, $proposalItem->getPrice())), 2) ?></p>
    </div>
</div>
    <?php
}
        ...
        <tr>
            ...
            <td <?php if ($k % 2) {
                ...
                if ($proposalItem->getItem()->getItemId() != 11) {
                    ...
                    if ($proposalItem->getItem()->getItemId() == 2) {
                        echo ' (';
                        $fv = $proposalItem->getFieldsValues();
                        foreach ($fv as $fieldValue) {
                            if ($fieldValue->getField()->getFieldLabel() == 'repair_type') {
