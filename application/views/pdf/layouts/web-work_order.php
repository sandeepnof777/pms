...
<head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?v=3&key=<?php echo $_ENV['GOOGLE_API_KEY']; ?>"></script>
     <input type="hidden" id="work_order_layout" value="<?php echo $work_order_layout; ?>">
    <?php
       if($work_order_layout){?>
        <style>
              .doc-section
             {
   ...
   <?php  if($nosidebar){?>
        <style>
         .imageContain
            ...
            @media all and (min-width: 320px) and (max-height: 430px){
                .image-section{
                /* float:none!important; */
                } 
                .map-direction {
            ...
            @media all and (max-width:430px) and (max-height:932px){
                .doc-section .top_table a{
                font-size:15px!important;
            }

            .doc-section .item-content-texts li a {
            ...
            @media all and (min-width: 375px) and (min-height: 667px) and (orientation: portrait) {
                ...
                #estimateSummaryItems{margin-left:-7px!important;}
            }
...
body{
        ...
        $counterArray = [];
            foreach($workOrderSections as $workOrderSection){
                 ...
                 echo '#'.$workOrderSection->section_code.'{order:'.$i.'!important}
                 ';
                echo 'li[data-page-id="'.$workOrderSection->section_code.'"] {order:'.$i.'!important}
                ';
                
                if($i % 2 != 0){
                    
                    echo 'li[data-page-id="'.$workOrderSection->section_code.'"] {background: rgba(0, 0, 0, 0.05);}
                    ';
                    
                }
                
                if($workOrderSection->c_visible == 0){
                    echo '#'.$workOrderSection->section_code.'{display:none!important}
                    ';
                    echo 'li[data-page-id="'.$workOrderSection->section_code.'"] {display:none!important}
                    ';
                }else{


                    $counterArray[$workOrderSection->section_code] = $page_counter;


                    switch ($workOrderSection->section_code) {
                        case 'images':
                            if (count($images)) {
                                $count =  ceil(count($images) / 4);
...
*/.map-height{min-height:500px; margin-top:15px;}
    ...
    <div class="row phone-potrait-margin-0">
        ...
        <nav class="col-md-3 nav " id="navbar-example3" style="width: 0px;">
            ...
            <div class="flex-shrink-0 p-3 bg-white sticky-sidebar scrollbar-primary">
                ...
                <ul class="list-unstyled ps-0 list-group-striped" style="max-height: 60%;overflow: auto;display: flex;flex-direction: column;">

                    <li class="mb-1" data-page-id="map-direction"><a href="#map-direction" class="btn sep-link align-items-center rounded">
                    ...
                    if ($lineItemCount>0) {
                        ...
                        <li class="mb-1" data-page-id="estimate_items"><a href="#estimate_items"
                    ...
                    if ($proposal->getWorkOrderNotes() || count($work_order_notes)) {
                    ?>
                    <li class="mb-1" data-page-id="notes-section">
...
<div class="header grid invoice print_hide sticky" id="infoHeader" style="padding: 0px 16px;">
            ...
            <div class="doc-section" id="doc-section" style="display: flex;flex-flow: wrap;">
                <!-- here we remove max-width define above in the conditional css -->              
                <div id="print_header" style="display:none;">
                    ...
                    <div class="grid invoice page_break no-header-element pdf-height" id="map-direction" data-page-id="cover">
                        <div class="grid-body">
                            <div class="row">
                        ...
                        <div class="row page_number">Page  <?= $counterArray['map-direction']; ?></div>
                ...
                <div class="grid invoice pdf-height page_break page_break_before" id="project_specifications" style="padding-top: 10px;"
...
if ($lineItemCount>0) {
   ?>
    <div class="grid invoice pdf-height page_break page_break_before" id="estimate_items" style="padding-top: 10px;" data-page-id="estimate_items">
            <div class="grid-body">
            <div class="row" >
    ...
    $j=0;
        ...
        <hr style="color:#2c2c2c;border-top:1px;margin-top:4px;margin-bottom:0px;"/>
            ...
            <div class="row">
                ...
                <table id="estimateSummaryItems" class="table table-striped table-bordered estimatedItems" style="width: 100%;">
                    <thead>
                    <tr>
                        <!-- <th width="30%">Type</th>
                        <th width="50%">Item</th>
...
?>
        ...
        <div class="row page_number">Page <?= $counterArray['estimate_items']; ?></div>
    </div>
    <?php }?>
                    ...
                    <div class="col-12 col-sm-6 col-md-6 mg-btm-20 break-after image-section"
                        ...
                        <div style="position: relative;">
                            ...
                            <img data-slide="slide-image-<?= $j; ?>"
                                 ...
                                 style="padding:0px;object-fit: cover; height:280px; width:100%;"
                                 src="<?php echo $image['src']; ?>" alt="">
...
<div class="grid invoice pdf-height  page_break_before mg-left-55" data-page-id="images" style="padding-top: 10px;" <?php //if($j==1){echo ' id="images"';}?> >
            ...
            <?php
                        ...
                        <div class="grid-body">
                            <div class="row">
                                ...
                                <div class="row" style="margin-left:0px">
                                    <h1 class="underlined global_header intro_video_title"> <?php echo $work_order_intro_video->getTitle(); ?></h1>
                                    <div class="logotopright ">
                                        <img class="theLogo" src="data:image/png;base64, <?php echo base64_encode(file_get_contents(UPLOADPATH . '/clients/logos/' . $proposal->getClient()->getCompany()->getCompanyLogo())) ?>" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <?php
                                    ...
                                    if ($work_order_intro_video->getCompanyVideoId() != 0 && $work_order_intro_video->getCompanyCoverImage() != '') {
                                        $companyThumbImage = $work_order_intro_video->getCompanyCoverImage();
                                    }
                                    $url = $work_order_intro_video->getVideoUrl();
                                    if ($work_order_intro_video->getEmbedVideoUrl()) {
                                        $finalUrl = $work_order_intro_video->getEmbedVideoUrl();
                                    } else {
                                        $finalUrl = $url;
                                    }
                                    $iframVideoClass = '';
                                    ...
                                    if ($work_order_intro_video->getIsLargePreview()) {
                                    ...
                                    <div class="<?= $box_size; ?> col-sm-12 text-center" style="margin-bottom:20px;">
                                        ...
                                        <?php if ($buttonShow) { ?>
                                            <!-- <h3 class="video_title"><?php //echo $work_order_intro_video->getTitle(); ?></h3> -->

                                            <a href="<?php echo $url; ?>" class="btn btn-primary"
                                               style="min-width:150px;width: auto;margin: auto;" target="_blank"><i
                                                        class="fa fa-fw fa-play-circle-o"></i>Play: <?php echo $work_order_intro_video->getTitle(); ?>
                                            </a>
                                        <?php } else { ?>
                                            <!-- <h3 class="video_title"><?php //echo $work_order_intro_video->getTitle(); ?></h3> -->

                                            <div class="embed-responsive embed-responsive-16by9 video"
                                                 data-video-id="<?php echo $work_order_intro_video->getId(); ?>">
                                                <?php
                                                $autoplay = '';
                                                ...
                                                if ($work_order_intro_video->getThumbnailImage() || $companyThumbImage) {
                                                    if ($work_order_intro_video->getThumbnailImage()) {
                                                        $thumbImageURL = $proposal->getSitePathUploadDir() . '/' . $work_order_intro_video->getThumbnailImage();
                                                    } else {
                                                    ...
                                                    <div class="play-overlay">
                                                        <a href="javascript:void(0)" class="play-icon">
                                                            ...
                                                            <img style="width: 70px;height: 70px;position: relative;" src="<?php echo site_url('static\images').'\video-player-icon_'.($work_order_intro_video->getPlayerIconColor() ? $work_order_intro_video->getPlayerIconColor() : 1).'.png'; ?>" >

                                                        </a>
                                                    </div>
                                                    <!-- <iframe class="embed-responsive-item proposal_video_ifram <?php echo $iframVideoClass; ?>" data-video-type="<?= $videoType; ?>" video_id="<?php echo $work_order_intro_video->getId(); ?>"  id="embed-responsive-video-<?php echo $work_order_intro_video->getId(); ?>" src="<?php echo $finalUrl . $autoplay; ?>"
                                        ...
                                        <div class="embed-responsive embed-responsive-16by9 video" data-video-id="<?php echo $video->getId(); ?>">
                                            ...
                                            if ($video->getThumbnailImage() || $companyThumbImage) {
                                                ...
                                                <img src="<?= $thumbImageURL; ?>" >
                                                         <div class="play-overlay">
                                                            <a href="javascript:void(0)" class="play-icon">
                                                                <img style="width: 70px;height: 70px;position: relative;" src="<?php echo site_url('static\images').'\video-player-icon_'.($video->getPlayerIconColor() ? $video->getPlayerIconColor() : 1).'.png'; ?>" >
                                                            </a>
                                                        </div>
                ...
                if ($proposal->getWorkOrderNotes() || count($work_order_notes)) {
                    ...
                    <div class="row page_number">Page <?= $counterArray['notes-section']; ?></div>
                        </div>
                    <?php
                }?>
...
<?php if (!$buttonShow) { ?>
    ...
    <!-- testProposal Video Opens here -->
        <div class="offcanvas offcanvas-end VideoPlayersOffcanvas" tabindex="-1"
...
if($work_order_intro_video) {
    ...
    <?php if (!$buttonShow) { ?>
        ...
        <div class="offcanvas  VideoPlayersOffcanvas" tabindex="-1"
             id="VideoPlayersOffcanvas_<?php echo $work_order_intro_video->getId(); ?>" aria-labelledby="offcanvasRightLabel">

    <span class="video-close-right-btn close_video_popup" data-video-id="<?php echo $work_order_intro_video->getId(); ?>">
        <button type="button" class="btn-close text-reset btn-close-white" data-bs-dismiss="offcanvas"
                aria-label="Close"></button>
    </span>

            <div class="offcanvas-body pad-top-0 video_player_iframe_body"
                 id="video_player_iframe_body_<?php echo $work_order_intro_video->getId(); ?>">
                <!-- <div class="videoLoaderDiv"><div class="spinner-border text-primary video-spinner" role="status" aria-hidden="true"></div><span class="spinner-text">Loading </span></div> -->
                <iframe class="embed-responsive-item proposal_video_ifram <?php echo $iframVideoClass; ?>"
                        data-video-type="<?= $videoType; ?>" video_id="<?php echo $work_order_intro_video->getId(); ?>"
                        id="embed-responsive-video-<?php echo $work_order_intro_video->getId(); ?>"
                        src="<?php echo $finalUrl . $autoplay; ?>" style="-webkit-overflow-scrolling:touch;"
                        allowfullscreen allow="autoplay"></iframe>
            </div>
        </div>
