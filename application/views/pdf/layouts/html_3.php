 ...
 */
?>
<h1 class="title_big">Pavement Maintenance Proposal</h1>
...
<h1 class="title_big2">Service Provider Information</h1>
...
?>
<div style="page-break-after: always"></div>
<h1 class="underlined">Price Breakdown: <?php echo $proposal->getProjectName()  ?></h1>
...
if (count($specs)) {
    ?>
<div style="page-break-after: always"></div>
<h1 class="underlined">Product Info</h1>
    <?php
...
if (count($attachments)) {
    ?>
<div style="page-break-after: always"></div>
<h1 class="underlined">Attachments</h1>
