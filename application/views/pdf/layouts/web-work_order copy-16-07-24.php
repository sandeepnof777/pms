                ...
                if (count($images)) {
                    ...
                    <div id="images">
                                ...
                                case 1:
                                    ...
                                    if ($tableOpen) {
                                        if ($old_layout == 2) {
                                            ...
                                            echo '</div><div class="row page_number">Page ' . $counterArray['images']++ . '</div></div>';
                                ...
                                case 2:
                                    ...
                                    if ($tableOpen) {
                                        if ($old_layout == 1) {
                                            ...
                                            //close table
                                            echo '<div class="row page_number">Page ' . $counterArray['images']++ . '</div></div>';
                                            $tableOpen = 0;
                                        } else {
                        ...
                        if ($tableOpen) {
                            if ($old_layout == 1) {
                                //close table
                                echo '</div></div></div><div class="row page_number">Page ' . $counterArray['images']++  . '</div></div>';
                            } else if ($old_layout == 2) {
                                echo '</div></div><div class="row page_number">Page ' . $counterArray['images']++  . '</div></div>';
                            } else {
                                //close tr's if necessary...
                                if ($imageCount % 2) {
                                    echo '</div></div>';
                                ...
                                //close table
                                echo '<div></div></div></div><div class="row page_number">Page ' . $counterArray['images']++  . '</div></div>';
                            }
                        } ?>
                        ...
                        <div class="grid-body">
                            <div class="row">
                                ...
                                <div class="row" style="margin-left:0px">
                                    <h1 class="underlined global_header" style="text-align: center;"> <?php echo $work_order_intro_video->getTitle(); ?></h1>
