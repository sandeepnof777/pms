...
if ($proposal_intro_video) {
						...
						?>
        <div style="height: 350px;" id="introvideoURL" >
...
<?php
    ...
    <a style="width: 100%;float:left;" target="_blank" href="<?php echo $proposal_intro_video->getVideoUrl(); ?>"> 
        ...
        <img width="100px" style="position: absolute;top: 100px;left: 65%;" src="data:image/png;base64, <?php echo base64_encode(file_get_contents(STATIC_PATH.'/images/play-video.png')); ?>"  >
    </a>
