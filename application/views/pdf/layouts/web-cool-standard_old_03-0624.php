...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;700&family=Hind:wght@400;500&family=Roboto:wght@300;400;500;600;700&display=swap" rel="stylesheet">
...
.mb-3 {
    margin-bottom: 0.4rem !important;
            ...
            and (-webkit-device-pixel-ratio: 2) and (orientation: portrait) {
                /* Your styles for iPhone 6, 6s, 7, 8 in portrait mode */
                ...
                /* Add some margin between buttons for smaller screens */
                .signature-pad--footer .signature-pad--actions button {
                    margin: 0 5px;
                }

                /* Stack nav-tabs vertically for smaller screens */
                .nav-tabs {
                    display: flex;
                    /* Display as flexbox */
                    ...
                    flex-wrap: nowrap;
                    /* Prevent wrapping to ensure inline display */
                }

                /* Adjust width and margin for nav-links */
                .nav-tabs .nav-link {
                    flex: 1;
                ...
                /* Adjust margin for type_preview_box */
                .type_preview_box {
                    margin-top: 10px;
                }

                /* Adjust max-width and display for previewImg */
                #previewImg {
                    max-width: 100%;
                    display: block;
                    margin: auto;
            ...
            and (-webkit-device-pixel-ratio: 3) and (orientation: portrait) {
                ...
                #save_signature_btn {
                    ...
                    /* Forcefully enable and display save_signature_btn */
                    width: 100%;
                    /* Set width to 100% */
                }
                ...
                /* Ensure visibility of clear, undo, save signature, and sign above buttons */
                #save_signature_btn,
    ...
    <style type="text/css">
        ...
        ?>#submitAskQuestionModal .modal-dialog,
        #submitSignModal .modal-dialog {
            width: 33%;
        }
...
<body>
    ...
    <div id="print_msg">
        ...
        <div class="note_print">
            <p>Please use the print button on the page as shown. <br /><br />This will generate a secure
                PDF for you to print.</p>
        </div>
    </div>
    <div id="trackingPointerLine" style="display: none; height: 10px; position: fixed; width: 100%; top:315px; background-color: red; z-index: 999999"></div>
    <?php
    $s = array('$', ',');
    $r = array('', '');
    $pdf_layout = 'cool';
    ...
    <a href="javascript:void(0)" class="btn-pause print_hide" data-container="body" data-bs-toggle="tooltip" data-bs-placement="left" title="Pause All"><i class="fa fa-pause"></i></a>
    <a href="javascript:void(0)" class="btn-zoom zoom print_hide small_device_hide ipad_hide small_device_hide_l" data-container="body" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom In"><i class="fa fa-plus"></i></a>
    <a href="javascript:void(0)" class="btn-zoom zoom-out print_hide small_device_hide ipad_hide small_device_hide_l" data-container="body" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom Out"><i class="fa fa-minus"></i></a>
    <a href="javascript:void(0)" class="btn-zoom zoom-init print_hide small_device_hide ipad_hide small_device_hide_l" data-container="body" data-bs-toggle="tooltip" data-bs-placement="left" title="Reset Zoom"><i class="fa fa-undo"></i></a>
    <a href="<?= $_SERVER['REQUEST_URI'] . '/print'; ?>" target="_blank" class="btn-zoom print-btn print_hide small_device_hide ipad_hide small_device_hide_l" data-container="body" data-bs-toggle="tooltip" data-bs-placement="left" title="Print"><i class="fa fa-print"></i></a>
    <div class="container-fluid">
        <button type="button" class="btn btn-dark  print_hide  <?php if ($nosidebar) {
                            ...
                            } ?> aria-label="Close"><i class="fa fa-chevron-left sidebar-btn-icon"></i></button>
        ...
        <div class="row phone-potrait-margin-0">
            ...
            <nav class="col-md-3 nav " id="navbar-example3" <?php if ($nosidebar) {
                ...
                <div class="flex-shrink-0 p-3 bg-white sticky-sidebar scrollbar-primary">
                    ...
                    <a href="#" class="d-flex align-items-center pb-3 sidebarTitle link-dark text-decoration-none border-bottom">
                    ...
                    <ul class="list-unstyled ps-0 list-group-striped" style="display: flex;flex-direction: column;">
                        ...
                        <li class="mb-1 " data-page-id="project_specifications">
                            <a href="#project_specifications" class="sep-link btn btn-toggle align-items-center rounded collapsed proposal_service_btn" data-bs-toggle="collapse" data-bs-target="#home-collapse" aria-expanded="false">
                                <i class="fa fa-fw fa-list"></i>&nbsp;&nbsp;Project Specifications
                            </a>
                            <div class="collapse" id="home-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <?php foreach ($services as $service) { ?>
                                        <li><a href="#service_<?= $service->getServiceId(); ?>" data-parent-menu-class="proposal_service_btn" class="btn sep-link rounded inline-block sub_menu"><?php echo $service->getServiceName();
                                                                                                                                                                                                    if ($service->isOptional()) { ?><span class="badge rounded-pill bg-info pull-right" data-container="body" data-bs-toggle="tooltip" data-bs-placement="right" title="Optional Service">OS</span><?php } ?></a></li>
                                    <?php } ?>
                        ...
                        <?php
                        if (count($map_images)) { ?>
                            <li class="mb-1" data-page-id="map_images"><a href="#map_images" class=" btn sep-link align-items-center rounded">
                        ...
                        if (count($images)) { ?>
                            <li class="mb-1" data-page-id="images"><a href="#images" class="image_section_btn btn sep-link align-items-center rounded">
                        ...
                        ?>
                            ...
                            <li class="mb-1" data-page-id="video"><a href="#video" class="video_section_btn btn sep-link align-items-center rounded">
            ...
            <div class="boxed-section" id="boxed-section" <?php if ($nosidebar) {
                    ...
                    <div class="grid-body">
                        <div class="row">
                            <div class="col-lg-2 col-md-3 col-sm-3 ipad2 pd-t-5 pd-l-0 info_header_logo">
                                <img class="mg-left--4" src="<?php echo site_url('uploads/clients/logos/' . $proposal->getClient()->getCompany()->getCompanyLogo() . '?' . time()); ?>" width="125px" height="auto" alt="">
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 ipad3 pd-t-10 pull-right-md info_header_buttons">
                                ...
                                <?php if ($track_activity) { ?>
                                    <button type="button" id="ask_question_open_canvas_btn" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight3" aria-controls="offcanvasRight" class="btn btn-primary btn-sm  pave-btn tiptip" title="Ask Question"><i class="fa fa-fw fa-question-circle"></i> <span class="button-text">Ask Question</span>
                                    </button>
                                    <a href="<?= $_SERVER['REQUEST_URI'] . '/download'; ?>" download="<?= $proposal->getProjectName(); ?>" class="download-btn btn btn-primary btn-sm mg-l-10 pave-btn tiptip" title="Download"><i class="fa fa-fw fa-download"></i> <span class="button-text">Download</span></a>
                                    <button class="btn btn-toggle2 align-items-center rounded collapsed header-info-btn" data-bs-toggle="collapse" data-bs-target="#info-collapse" aria-expanded="false">
                                    </button>
                                <?php } ?>
                ...
                <div class="doc-section" id="doc-section">
                    ...
                    ?>
                            <div id="title-page" class="grid invoice page_break no-header-element pdf-height mg-left-55 " data-page-id="cover">
                                <div class="grid-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="issuedby pull-right">
                                                    <p class="clearfix" style="line-height: 16px;">
                                                        <img class="" src="<?php echo site_url('uploads/clients/logos/' . $proposal->getClient()->getCompany()->getCompanyLogo() . '?' . time()); ?>" alt=""><br>
                        ...
                        <?php } else {
                        ?>
                            <div id="title-page" class="grid invoice page_break no-header-element pdf-height mg-left-55 custom-background" style="background-image: url('<?= $proposal->getCoverImageSrc('-orig'); ?>');" data-page-id="cover">
                                <div class="grid-body">
                                    <div class="invoice-title avoid-break">
                                        <div class="row">

                                            <div class="col-md-12">
                                                <h1 class="title_big ft-s-28 custom_title_big" style="border-radius: 10px;padding-top:0px;width: 90%;background-color: #<?= $proposal->getHeaderBgColor(); ?>;color: #<?= $proposal->getHeaderFontColor(); ?>;margin-top: 180px;"><?php echo $proposal->getProposalTitle() ?></h1>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row coverHr">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 " style="margin: auto;">
                                                <div style="margin-top:80px;border-radius: 10px;background-color: #<?= $proposal->getHeaderBgColor(); ?>;color: #<?= $proposal->getHeaderFontColor(); ?>;">
                                                    ...
                                                    <h3 class="company_owner2" style="margin-top: 15px;"><?php echo $proposal->getProjectName() ?></h3>
                                                    <?php if ($proposal->getProjectAddress()) { ?>
                        ...
                        <div class="grid invoice page_break no-header-element pdf-height mg-left-55" id="service-provider" data-page-id="provider">
                            <div>

                                <div class="row">
                                    <div class="col-md-12">
                                        <h1 id="service_provider_title" class="ft-s-28" style="z-index: 200;text-align:center"><?php echo $proposal->getClient()->getCompany()->getPdfHeader() ?></h1>
                                    </div>
                                </div>
                                <br>
                                <div class="row company_info_row ">
                                    <div class="col-md-6 company-info-section" style="text-align:center">
                                        ...
                                        <img class="theLogo" src="<?php echo site_url('uploads/clients/logos/' . $proposal->getClient()->getCompany()->getCompanyLogo() . '?' . time()) ?>" alt="">
                                        <p style="margin-block-start: 22px;"><?php echo $proposal->getClient()->getCompany()->getCompanyName() ?>
                                            ...
                                            <?php if ($proposal->getClient()->getCompany()->getFax() || $proposal->getOwner()->getFax()) { ?>
                                                ...
                                                <br>
                                            <?php } ?>
                                            <a style="font-size: 14px;" target="_blank" href="<?php echo $proposal->getClient()->getCompany()->getCompanyWebsite() ?>"><?php echo $proposal->getClient()->getCompany()->getCompanyWebsite() ?></a><br>
                                        </p>
                                    </div>
                                ...
                                ?>
                                    <div id="videoURL" width="100%">
                                        <?php foreach ($proposal_videos as $video) { ?>
                                            ...
                                            <a href="<?php echo $video->getVideoUrl() ?>" target="_blank"><img src="data:image/png;base64, <?php echo base64_encode(file_get_contents(UPLOADPATH . '/proposal-video.jpg')); ?>" width="90%"></a>
                                        ...
                                        <div style="page-break-inside: avoid">
                                            <div class="item-content audit print_hide">
                                                <h2 class="property_heading" style="text-align: left;margin-top:0px;">Your
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn-primary openAuditIframe" id="inspection_btn" style="top:6px" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight4" aria-controls="offcanvasRight">Click
                                                        Here</a>
                                                    <a href="<?php echo $proposal->getAuditReportUrl(true); ?>" id="mobile_openAuditIframe" target="_blank" style="display: none;">Click</a>
                                                </h2>
                                            ...
                                            <img src="<?= site_url('static/images/property_section2.png'); ?>" class="small_device_hide"  style="width: 100%; height:auto;"/>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <a href="javascript:void(0)" class="openAuditIframe" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight4" aria-controls="offcanvasRight">
                                                            <!-- <img src="<?= site_url('static/images/property_section.png'); ?>" class="mobile_img"  style="width: 100%; height:auto;"/> -->
                                                            <img src="<?= site_url('static/images/psa.gif'); ?>" class="" style="width: 100%; height:auto;" />
                                                        </a>
                                                    </div>
                            ...
                            <div class="grid-body">
                                <div class="row">
                                    ...
                                    <div class="row" style="margin-left:0px">
                                        <h1 class="underlined global_header" style="text-align: center;"> <?php echo $proposal_intro_video->getTitle(); ?></h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="<?= $box_size; ?> col-sm-12 text-center" style="margin-bottom:20px;">
                                        ...
                                        <?php if ($buttonShow) { ?>
                                            <!-- <h3 class="video_title"><?php //echo $proposal_intro_video->getTitle(); 
                                                                            ?></h3> -->

                                            <a href="<?php echo $url; ?>" class="btn btn-primary" style="min-width:150px;width: auto;margin: auto;" target="_blank"><i class="fa fa-fw fa-play-circle-o"></i>Play: <?php echo $proposal_intro_video->getTitle(); ?>
                                            </a>
                                        <?php } else { ?>
                                            <!-- <h3 class="video_title"><?php //echo $proposal_intro_video->getTitle(); 
                                                                            ?></h3> -->

                                            <div class="embed-responsive embed-responsive-16by9 video " data-video-id="<?php echo $proposal_intro_video->getId(); ?>">
                                                <?php
                                                $autoplay = '';
                    ...
                    if ($template == 'web-cool' || $template == 'web-custom') {
                        if ($proposal->getAuditKey()) {
                    ?>
                            <div class="grid invoice print_hide mg-left-55" style="padding-top: 10px;" id="audit-section" data-page-id="audit">
                                <div class="grid-body">
                                    <div class="row">
                                        <h1 class="underlined global_header ft-s-22">Property Inspection / Audit</h1>
                                        <div class="logotopright small_device_hide"><img class="theLogo" style="height: 35px; width: 120px; margin-right: 8px;" src="data:image/png;base64, <?php echo base64_encode(file_get_contents(
                                                                                                                                                                                                UPLOADPATH . '/clients/logos/' . $proposal->getClient()->getCompany()->getCompanyLogo()
                                                                                                                                                                                            )) ?>" alt=""></div>
                                    </div>
                                    <div style="page-break-inside: avoid">
                                        <div class="item-content audit print_hide">
                                            <h2 class="property_heading" style="text-align: left;margin-top:0px;">Your
                                                Customized Inspection
                                                <a href="javascript:void(0)" class="btn btn-primary openAuditIframe" id="inspection_btn" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight4" aria-controls="offcanvasRight">Click
                                                    Here</a>
                                                <a href="<?php echo $proposal->getAuditReportUrl(true); ?>" id="mobile_openAuditIframe" target="_blank" style="display: none;">Click</a>
                                            </h2>
                    ...
                    <div class="grid invoice pdf-height page_break page_break_before mg-left-55" style="padding-top: 10px;" data-page-id="services" id="project_specifications">
                        <div class="grid-body">
                            <div class="row">
                                <div class="row">
                            ...
                            <div class="row">
                                ...
                                foreach ($services as $service) {
                                    ...
                                    if (!$proposal->hasSnow()) {
                                    ?>
                                        <div class="col-md-12 margin-top-bottom-10 avoid-break service-section" style="float: left;" id="service_<?php echo $service->getServiceId() ?>" data-service-id="<?php echo $service->getServiceId() ?>">
                                            <div style="position: relative;" class="item-content<?php echo ($service->isNoPrice()) ? ' no-price' : ''; ?> ">
                                                <h2 class="service_title pave-text-color"><?php echo $service->getServiceName() ?>
                                                    <a href="javascript:void(0)" class="serviceNameList not_link" style="color: #25AAE1;" data-service-optional="0" data-bs-toggle="offcanvas" data-bs-target="#serviceOffcanvasRight" aria-controls="offcanvasRight" data-service-id="service_<?php echo $service->getServiceId() ?>" data-service-ind-id="<?php echo $service->getServiceId() ?>" data-map-area="<?php echo $service->getMapAreaData(); ?>">
                                                        <i data-bs-placement="right" data-container="body" data-bs-toggle="tooltip" title="View Service Details" class="fa fa-fw fa-external-link"></i></a>
                                                </h2>
                                                <?php
                                                if ($service->isOptional()) {
                                                ?>
                                                    <span class="optional_service_badge badge bg-secondary" style="position: absolute;right: 10px;top:-22px;font-size: 12px;background-color:#25aae1!important">Optional Service</span>
                                                <?php } ?>
                                                ...
                                                ?>
                                                    <span class="service_text_total" style="width:100%;float:left;text-align:center;margin-top: 7px;"><strong>Total Price:</strong> <?php
                                                ...
                                                <div class="row" style="clear: both;">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="col-12 col-sm-<?= $col; ?> col-md-<?= $col; ?> mg-btm-20 break-after image-section" style="float: left;padding:5px 0px;" data-image-id="<?php echo $image['id']; ?>">


                                                            <div class="mx-auto d-block" style="position: relative; width:<?= $width; ?>;">
                                                                <div style="position: relative;">
                                                                    <h2 class="image_title" style="font-size: 15px;margin: 10px 0px 0px 0px;"><?php echo $image['title'] ?></h2>
                                                                    <?php if ($image['notes']) { ?>
                                                                        <a href="javascript:void(0)" data-bs-toggle="offcanvas" data-bs-target="#mobileImageInfo" aria-controls="offcanvasRight" class="image-section-info not_link">
                                                                    ...
                                                                    <img data-slide="slide-image-<?= $lop++; ?>" data-image-id="<?php echo $image['id']; ?>" data-bs-toggle="offcanvas" data-bs-target="#service_image_offcanvas_<?= $service->getServiceId(); ?>" aria-controls="offcanvasRight" class="img-fluid img-thumbnail img_service_mobile btn showProposalCarousel " style="object-fit: cover;padding-right: 0px;padding-left: 0;height:150px;width: 100%;" src="<?php echo $image['src']; ?>" alt="">

                                                                    <?php
                                                                    if ($image['notes']) {
                                                                    ?>
                                                                        <a href="javascript:void(0)" data-placement="top" data-container="body" data-bs-toggle="tooltip" title="View Notes" data-bs-custom-class="custom-tooltip" class="image-note-section-info not_link" style="right: 85px;bottom: 7px;">
                                                                            <i class="fa fa-info-circle"></i>
                                                                        </a>
                                                                    <?php } ?>

                                                                    <p class="image-section-inlarge-text" style="pointer-events: none;right: 2px;bottom: -9px;padding-top: 1px;">
                                                                        + Enlarge</p>
                                                                </div>
                                                                <div class="image-section-notes" style="display: none;position: relative;padding: 5px;width: 100%;border-radius: 5px;border: 1px solid #939090;max-height: 100px;overflow-y: auto;"><?= $image['notes']; ?>
                                    ...
                                    ?>
                                        <div class="col-md-12 margin-top-bottom-10 avoid-break service-section" id="service_<?php echo $service->getServiceId() ?>" style="page-break-inside: avoid" data-service-id="<?php echo $service->getServiceId() ?>">
                            ...
                            ?>
                                    <div class="grid invoice pdf-height  page_break_before mg-left-55" data-page-id="images" style="padding-top: 10px;" <?php //if($j==1){echo ' id="images"';}
                                        ...
                                        if ($imageCount == 2) {
                                            ...
                                            <div class="col-12 col-sm-6 col-md-6 mg-btm-20 break-after image-section" data-image-id="<?php echo $image['id']; ?>">
                                                <?php if ($j == 1) { ?>


                                                    <div class="row">

                                                        <h1 class="underlined global_header only_show_print" style="width: 725px;">
                                                            Proposal: <?php echo $proposal->getProjectName() ?> </h1>
                                                        <div class="logotopright only_show_print" style="top: -6px!important;left: 619px!important;"><img class="theLogo" style="height: 35px; width: 120px; margin-right: 8px;" src="data:image/png;base64, <?php echo base64_encode(file_get_contents(
                                                                                                                                                                                                                                                                    UPLOADPATH . '/clients/logos/' . $proposal->getClient()->getCompany()->getCompanyLogo()
                                                                                                                                                                                                                                                                )) ?>" alt=""></div>
                                                    </div>
                                                <?php } ?>
                                                <div style="position: relative;">
                                                    ...
                                                    ?>
                                                        <a href="javascript:void(0)" data-bs-toggle="offcanvas" data-bs-target="#mobileImageInfo" aria-controls="offcanvasRight" class="image-section-info" style="margin-top: 1px;border-radius: 0px 5px 0px 5px;">
                                                            <i class="fa fa-info-circle"></i>
                                                        </a>
                                                    ...
                                                    <img data-slide="slide-image-<?= $j; ?>" data-image-id="<?php echo $image['id']; ?>" data-bs-toggle="offcanvas" data-bs-target="#offcanvasMapImage" aria-controls="offcanvasRight" class="<?php echo ($image['orientation'] == 'landscape') ? 'proposalImage_l' : 'proposalImage_p'; ?> img-fluid img-thumbnail  btn showProposalCarousel" style="padding:0px;object-fit: cover; height:280px; width:100%;" src="<?php echo $image['src']; ?>" alt="">

                                                    <?php
                                                    if ($image['notes']) {
                                                    ?>
                                                        <a href="javascript:void(0)" data-placement="top" data-container="body" data-bs-toggle="tooltip" title="View Notes" data-bs-custom-class="custom-tooltip" class="image-note-section-info ">
                                                            <i class="fa fa-info-circle"></i>
                                                        </a>
                                                    <?php } ?>

                                                    <p class="image-section-inlarge-text" style="bottom: -15px;pointer-events: none;"><i class="fa fa-plus"></i>
                                                        Enlarge</p>
                                                </div>
                                                <div class="image-section-notes" style="display: none;position: relative;padding: 5px;width: 100%;border-radius: 5px;border: 1px solid #939090;max-height: 100px;overflow-y: auto;"><?= $image['notes']; ?>
                                                    <span class="close"></span>
                                        ...
                                        <div class="row page_number">Page <?= $counterArray['map_images']++; ?></div>
                                    </div>
                            <?php
                                                $tableOpen = 0;
                                            }
                    ...
                    ?>
                        ...
                        <div class="row page_number">Page <?= $counterArray['images']++; ?></div>
                </div>
            <?php }
                                }
    ...
    <div class="grid invoice pdf-height  page_break_before mg-left-55" data-page-id="images" style="padding-top: 10px;" <?php //if($j==1){echo ' id="images"';}
        ...
        <div class="col-12  mg-btm-20 break-after image-section <?php echo $cssForCol; ?>" data-image-id="<?php echo $image['id']; ?>" style="float:left;padding: 0 10px;max-height:none">
            ...
            <div style="position: relative;">
                ...
                <img data-slide="slide-image-<?= $j; ?>" data-image-id="<?php echo $image['id']; ?>" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight2" aria-controls="offcanvasRight" class="<?php echo ($image['orientation'] == 'landscape') ? 'proposalImage_l' : 'proposalImage_p'; ?> img-fluid img-thumbnail  btn showProposalCarousel" style="padding:0px;object-fit: cover; height:<?php echo $imgHeight; ?>; width:100%;" src="<?php echo $image['src']; ?>" alt="">
                ...
                ?>
                    ...
                    <div class="<?= $box_size; ?> col-sm-12" style="margin-bottom:20px;">
                        ...
                        <?php if ($buttonShow) { ?>
                            ...
                            <a href="<?php echo $url; ?>" class="btn btn-primary" style="min-width:150px;width: auto;margin: auto;" target="_blank"><i class="fa fa-fw fa-play-circle-o"></i>Play: <?php echo $video->getTitle(); ?>
                            </a>
                        <?php } else { ?>
                            <h3 class="video_title"><?= $videoCounter; ?>
                                . <?php echo $video->getTitle(); ?></h3>
                            ...
                            <div class="embed-responsive embed-responsive-16by9 video " data-video-id="<?php echo $video->getId(); ?>">
                                ...
                                <?php } else {
                                    ...
                                    //     $video_id = (int)$urlParts[count($urlParts) - 1];
                                    //     $newThumbImageURL = "https://vumbnail.com/" . $video_id . ".jpg";
                                    //     $handle = @fopen($newThumbImageURL, 'r');
                                    //     if(!$handle){
                                    //         $newThumbImageURL = site_url('static/images/video_play.png');
                                    //     }else{
                                    //         $showPlayerIcon = true;
...
<!-- END Videos -->
<!-- BEGIN INVOICE -->
<div class="grid invoice pdf-height page_break page_break_before mg-left-55" style="padding-top: 10px;" id="price-breakdown" data-page-id="price">
    <div class="grid-body">
        <div class="row">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td <?php if ($k % 2) {
                                            echo 'class="odd"';
                                        } ?>><a href="javascript:void(0)" class="serviceNameList" data-service-optional="0" data-bs-toggle="offcanvas" data-bs-target="#serviceOffcanvasRight" aria-controls="offcanvasRight" data-service-id="service_<?php echo $service->getServiceId() ?>" data-service-ind-id="<?php echo $service->getServiceId() ?>" data-map-area="<?php if ($isMapDataAdded) {
                        ...
                        <?php if (!isset($hideTotalPrice) || !$hideTotalPrice) { ?>
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <?php if ($isMapDataAdded) { ?>
                                        <td></td> <?php } ?>
                                    <td align="right"><strong>Total: <span class="show_only_mobile">$<?php echo number_format($total + $taxTotal, 2) ?></span></strong>
                                    </td>
                                    <td style="text-align: right">
                                        <strong>$<?php
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td <?php if ($k % 2) {
                                                echo 'class="odd"';
                                            } ?>><a href="javascript:void(0)" class="serviceNameList" data-service-optional="1" data-bs-toggle="offcanvas" data-bs-target="#serviceOffcanvasRight" aria-controls="offcanvasRight" data-service-id="service_<?php echo $service->getServiceId() ?>" data-service-ind-id="<?php echo $service->getServiceId() ?>" data-map-area="<?php if ($isMapDataAdded) {
                                                                                                                                                                                                                                                                                                                                                                                            echo $service->getMapAreaData();
                                                                                                                                                                                                                                                                                                                                                                                        } ?>"> <?php
                                                                    if ($taxprice > 0) {
                                                                        echo '<span style="font-weight:bold;vertical-align: sub;">* </span>';
        ...
        <div class="row">
            ...
            <div style="page-break-inside: avoid">
                ...
                <table border="0" class="mg-t-22 ">
                    <tr>
                        <td width="30">Date:</td>
                        <td width="120" id="signed_date" style="border-bottom: 1px solid #000;white-space: nowrap;">
                            &nbsp; <?php if (isset($clientSignature) && ($clientSignature)) {
                                        echo date('m/d/Y', strtotime($clientSignature->getCreatedAt()));
                                    } ?>
                    ...
                    <div class="col-md-6 col-lg-6 ">
                        <div class="client_signature_td">
                            ...
                            if ($clientSignature) {
                                ...
                                if (file_exists(UPLOADPATH . '/proposal_signature/' . $proposal->getProposalId() . '/' . $clientSignature->getSignatureFile())) { ?>
                                    <img style="width: auto; max-height: 70px;" src="<?php echo site_url('uploads/proposal_signature/' . $proposal->getProposalId() . '/' . $clientSignature->getSignatureFile() . '?') . mt_rand(0, 1000); ?>" alt="">
                                <?php }
                                //Check signee view id
                                if ($showCompanySignatureButton) {
                                ?>
                                    <a type="button" class="btn btn-secondary btn-sm" data-client-sign-id="<?= $clientSignature->getId(); ?>" href="javascript:void(0)" id="deleteClientSignature"><i class="fa fa-fw fa-trash"></i></a>
                            <?php }
                            }
                            ...
                            ?>
                                ...
                                <button type="button" id="add_signature" data-firstname="<?php echo ($clientSig) ? $client_firstname : $proposal->getClient()->getFirstName(); ?>" data-lastname="<?php echo ($clientSig) ? $client_lastname : $proposal->getClient()->getLastName(); ?>" data-company-name="<?php echo ($clientSig) ? $clientSig->getCompanyName() : $proposal->getClient()->getClientAccount()->getName(); ?>" data-title="<?php echo ($clientSig) ? $clientSig->getTitle() : $proposal->getClient()->getTitle(); ?>" data-email="<?php echo ($clientSig) ? $clientSig->getEmail() : $proposal->getClient()->getEmail(); ?>" data-address="<?php echo ($clientSig) ? $clientSig->getAddress() : $proposal->getClient()->getAddress(); ?>" data-city="<?php echo ($clientSig) ? $clientSig->getCity() : $proposal->getClient()->getCity(); ?>" data-state="<?php echo ($clientSig) ? $clientSig->getState() : $proposal->getClient()->getState(); ?>" data-zip="<?php echo ($clientSig) ? $clientSig->getZip() : $proposal->getClient()->getZip(); ?>" data-cell-phone="<?php echo ($clientSig) ? $clientSig->getCellPhone() : $proposal->getClient()->getCellPhone(); ?>" data-office-phone="<?php echo ($clientSig) ? $clientSig->getOfficePhone() : $proposal->getClient()->getBusinessPhone(true); ?>" data-type="client" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" class="btn btn-secondary btn-sm print_hide <?= $show_client_sign_btn; ?>">
                                    Sign
                                </button>
                        ...
                        <div valign="top" class="proposal-details">
                            ...
                            ?>
                                ...
                                <br />
                                <a target="_blank" href="mailto:<?php echo $clientSignature->getEmail(); ?>"><?php echo $clientSignature->getEmail(); ?></a>
                                <br />
                                <?php
                                ...
                                ?>
                                    <a target="_blank" href="mailto:<?php echo $clientSig->getEmail(); ?>"><?php echo $clientSig->getEmail(); ?></a>
                                    <br />
                                <?php
                                }
                                ...
                                <br>
                                <a target="_blank" href="mailto:<?php echo $proposal->getClient()->getEmail() ?>">
                            ...
                            if ($clientSignature) {
                                ?>
                                <!-- <span id="signed_span">Signed : <? //= date_format(date_create($clientSignature->getCreatedAt()), "m/d/y g:i A"); 
                                                                        ?></span> -->
                                <span id="signed_span">Signed : <?php echo  date('m/d/Y g:i A', strtotime($clientSignature->getCreatedAt()) + TIMEZONE_OFFSET); ?></span>
                    ...
                    <div class="col-md-6 col-lg-6 ">
                        <div class="company_signature_td">
                            ...
                            ?>
                                ...
                                if (file_exists(UPLOADPATH . '/proposal_signature/' . $proposal->getProposalId() . '/' . $companySignature->getSignatureFile())) { ?>
                                    <img style="width: auto; max-height: 70px;" src="<?php echo site_url('uploads/proposal_signature/' . $proposal->getProposalId() . '/' . $companySignature->getSignatureFile() . '?') . mt_rand(0, 1000); ?>" alt="">
                                <?php }
                                //Check signee view id
                                if ($showCompanySignatureButton) {
                                ?>
                                    <a type="button" class="btn btn-secondary btn-sm" data-company-sign-id="<?= $companySignature->getId(); ?>" href="javascript:void(0)" id="deleteCompanySignature"><i class="fa fa-fw fa-trash"></i></a>
                                <?php }
                            } else if (file_exists(UPLOADPATH . '/proposal_signature/' . $proposal->getProposalId() . '/company_signature.png')) {
                                $show_company_sign_btn = 'd-none';
                                ?>
                                <img style="width: auto; max-height: 70px;" src="<?php echo site_url('uploads/proposal_signature/' . $proposal->getProposalId() . '/company_signature.png?') . mt_rand(0, 1000); ?>" alt="">
                            <?php }
                            if ($showCompanySignatureButton) {
                                if ($companySig) {
                            ...
                            ?>
                                ...
                                <button type="button" id="add_signature_company" data-firstname="<?php echo ($companySig) ? $company_firstname : $proposal->getOwner()->getFirstName(); ?>" data-lastname="<?php echo ($companySig) ? $company_lastname : $proposal->getOwner()->getLastName(); ?>" data-company-name="<?php echo ($companySig) ? $companySig->getCompanyName() : $proposal->getOwner()->getCompany()->getCompanyName(); ?>" data-title="<?php echo ($companySig) ? $companySig->getTitle() : $proposal->getOwner()->getTitle(); ?>" data-email="<?php echo ($companySig) ? $companySig->getEmail() : $proposal->getOwner()->getEmail(); ?>" data-address="<?php echo ($companySig) ? $companySig->getAddress() : $proposal->getOwner()->getAddress(); ?>" data-city="<?php echo ($companySig) ? $companySig->getCity() : $proposal->getOwner()->getCity(); ?>" data-state="<?php echo ($companySig) ? $companySig->getState() : $proposal->getOwner()->getState(); ?>" data-zip="<?php echo ($companySig) ? $companySig->getZip() : $proposal->getOwner()->getZip(); ?>" data-cell-phone="<?php echo ($companySig) ? $companySig->getCellPhone() : $proposal->getOwner()->getCellPhone(); ?>" data-office-phone="<?php echo ($companySig) ? $companySig->getOfficePhone() : ''; ?>" data-type="company" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" class="btn btn-secondary btn-sm print_hide <?= $show_company_sign_btn; ?>">
                                    Sign
                                </button>
                        ...
                        <div class="signee-details">
                            ...
                            ?>
                                ...
                                <br />
                                <a target="_blank" href="mailto:<?php echo $companySignature->getEmail(); ?>"><?php echo $companySignature->getEmail(); ?></a>
                                <br />
                                <?php
                                ...
                                ?>
                                    <a target="_blank" href="mailto:<?php echo $companySig->getEmail(); ?>"><?php echo $companySig->getEmail(); ?></a>
                                    <br />
                                <?php
                                }
                            ...
                            <?php } else { ?>
                                ...
                                <br>
                                E: <a target="_blank" href="mailto:<?php echo $proposal->getOwner()->getEmail() ?>"><?php echo $proposal->getOwner()->getEmail() ?></a>
                                <br>
                                ...
                                <?php if ($proposal->getClient()->getCompany()->getFax() || $proposal->getOwner()->getFax()) { ?>
                                    ...
                                    <br>
                                <?php } ?>
                                <a target="_blank" href="<?php echo $proposal->getClient()->getCompany()->getCompanyWebsite() ?>"><?php echo $proposal->getClient()->getCompany()->getCompanyWebsite() ?></a>
                            <?php } ?>
                            <?php
                            if ($companySignature) {

                            ?>
                                <!-- <span id="signed_company_span">Signed : <? //= date_format(date_create($companySignature->getCreatedAt()), "m/d/y g:i A"); 
                                                                                ?></span> -->
                                <span id="signed_span">Signed : <?php echo date('m/d/Y g:i A', strtotime($companySignature->getCreatedAt()) + TIMEZONE_OFFSET); ?></span>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6 ">
                        <div class="other_signature_td <?= $show_client_sign_btn; ?>" style="border-bottom: 1px solid;position: relative;">
                            ...
                            <button type="button" id="add_other_signature" data-firstname="<?php echo ($clientSig) ? $client_firstname : $proposal->getClient()->getFirstName(); ?>" data-lastname="<?php echo ($clientSig) ? $client_lastname : $proposal->getClient()->getLastName(); ?>" data-company-name="<?php echo ($clientSig) ? $clientSig->getCompanyName() : $proposal->getClient()->getClientAccount()->getName(); ?>" data-title="<?php echo ($clientSig) ? $clientSig->getTitle() : $proposal->getClient()->getTitle(); ?>" data-email="<?php echo ($clientSig) ? $clientSig->getEmail() : $proposal->getClient()->getEmail(); ?>" data-address="<?php echo ($clientSig) ? $clientSig->getAddress() : $proposal->getClient()->getAddress(); ?>" data-city="<?php echo ($clientSig) ? $clientSig->getCity() : $proposal->getClient()->getCity(); ?>" data-state="<?php echo ($clientSig) ? $clientSig->getState() : $proposal->getClient()->getState(); ?>" data-zip="<?php echo ($clientSig) ? $clientSig->getZip() : $proposal->getClient()->getZip(); ?>" data-cell-phone="<?php echo ($clientSig) ? $clientSig->getCellPhone() : $proposal->getClient()->getCellPhone(); ?>" data-office-phone="<?php echo ($clientSig) ? $clientSig->getOfficePhone() : ''; ?>" data-type="other" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" class="btn btn-secondary btn-sm print_hide ">
                                Sign
                            </button>
                        </div>
                    </div>
        ...
        <div class="grid-body">
            <div class="row">
                <div class="row">
                    ...
                    <div class="logotopright small_device_hide">
                        <img class="theLogo" style="height: 35px; width: 120px; margin-right: 8px;" src="data:image/png;base64, <?php echo base64_encode(file_get_contents(
                                                                                                                                    UPLOADPATH . '/clients/logos/' . $proposal->getClient()->getCompany()->getCompanyLogo()
                                                                                                                                )) ?>" alt="">
                    </div>
                </div>
            ...
            <div class="row">
                <div style="page-break-inside: avoid">
                    <div class="col-md-6 col-lg-6 ">
                        ...
                        <a href="#" id="add_update_checklist" data-type="client" data-bs-toggle="offcanvas" data-bs-target="#offcanvasChecklist" aria-controls="offcanvasRight" class=" print_hide" style="text-decoration: none;font-size:18px;">
                            Add/Edit
                        </a>
                    </div>

                    <input type="hidden" id="billing_proposal_id" name="billing_proposal_id" value="<?php echo $proposal->getProposalId(); ?>">
                    <br><br>
                    <table border="0" cellpadding="0" cellspacing="0" class="customer-checklist-table">
                        <tr>
                            <td>
                                <p class="header_fix" style="font-size:18px;margin-left:180px;">
                        ...
                        <tr>
                            <td colspan="2"> <span class="span-label"><strong>Billing Contact:</strong></span>
                                <span class="span-data billing_contact">
                                    <?php if (isset($proposalChecklistData)) {
                        ...
                        <tr>
                            <td colspan="2"><span class="span-label"><strong>Billing Email:</strong></span>
                                <span class="span-data billing_email"><?php if (isset($proposalChecklistData)) {
...
if ($havetexts) { ?>
    ...
    <div class="grid invoice pdf-height page_break page_break_before mg-left-55" id="additional-info-section" style="padding-top: 10px;min-height: auto;" data-page-id="terms">
        <div class="grid-body">
            <div class="row">
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="font-size: 16px;">
                                ...
                                <p>
                                    <a href="https://local.psa/location/inventory/report/<?php echo $proposal->getInventoryReportUrl() ?>" target="_blank">View your
                                        Custom Site Inventory Report</a>
                                </p>
                            </td>
                        </tr>
                    </table>
                ...
                <div class="grid-body">
                    <div class="row">
                        <div style="padding-top: 30px; page-break-inside: avoid;">
                            ...
                            <table class="table mytable inventoryTable" style="width: 100%;" border="none" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>Category</th>
                                        <th>Type</th>
...
if (count($attachments) || count($proposal_attachments)) {
?>
    <div class="grid invoice pdf-height page_break_before mg-left-55" id="attachments" data-page-id="attachments">
        <div class="grid-body">
            ...
            <div class="row">
                ...
                <h1 class="underlined global_header only_show_print" style="width: 715px;">
                    Attachments </h1>
                <div class="logotopright small_device_hide" style="top: 45px!important;"><img class="theLogo" style="height: 35px; width: 120px; margin-right: 8px;" src="data:image/png;base64, <?php echo base64_encode(file_get_contents(
                                                                                                                                                                                                        UPLOADPATH . '/clients/logos/' . $proposal->getClient()->getCompany()->getCompanyLogo()
                                                                                                                                                                                                    )) ?>" alt=""></div>
                ...
                ?>
                    <div class="attachmentsTypes">
                        ...
                        foreach ($attachments as $attachment) {
                            $url = site_url('attachments/' . $proposal->getClient()->getCompany()->getCompanyId()) . '/' . $attachment->getFilePath();
                        ?>
                            <h3 id="AttachFile<?= $attachment->getAttatchmentId(); ?>" class="attachmentName"><a href="<?php echo str_replace(' ', '%20', $url) ?>" target="_blank"><?php echo $attachment->getFileName() ?></a>
                            </h3>
                        <?php
                        } ?>
                    </div>
                ...
                ?>
                    <div class="attachmentsTypes">
                        ...
                        foreach ($proposal_attachments as $attachment) {
                            $url = site_url('uploads/companies/' . $proposal->getClient()->getCompany()->getCompanyId() . '/proposals/' . $proposal->getProposalId() . '/' . $attachment->getFilePath());
                        ?>
                            <h3 class="attachmentName"><a href="<?php echo str_replace(' ', '%20', $url) ?>" target="_blank"><?php echo $attachment->getFileName() ?></a>
                            </h3>
                        <?php
                        } ?>
                    </div>
...
<button type="button" class="btn btn-newgrey mg-left-870 print_hide sectionChanger nextSection" aria-label="Close">
...
<!--Client Canvas-->
<div class="offcanvas offcanvas-none SignatureModal" id="offcanvasRight" aria-labelledby="offcanvasRightLabel" style="width:100%;">
    <div class="offcanvas-header">
        <legend class="text-left">Add Signature : <?php echo $proposal->getProposalTitle() ?></legend>
        <span class="new-popup-close-btn"><button type="button" class="btn-close text-reset btn-close-white" data-bs-dismiss="offcanvas" aria-label="Close"></button></span>
    </div>
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            ?>
                            <input type="text" required name="firstname" class="form-control sign_popup_inputs" value="" id="signature_firstname" placeholder="Enter First Name">
                            <input type="hidden" id="signature_type">
                            <div class="invalid-feedback"> Please enter First Name</div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="signature_lastname" class="form-label">Last Name</label>
                            <input type="text" required name="lastname" class="form-control sign_popup_inputs" value="" id="signature_lastname" placeholder="Enter Last Name">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" required name="company" class="form-control sign_popup_inputs" value="" id="signature_company" placeholder="Enter Company Name">
                            <div class="invalid-feedback"> Please enter Company Name</div>

                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="signature_title" class="form-label">Title</label>
                            <input type="text" required name="signature_title" class="form-control sign_popup_inputs" value="" id="signature_title" placeholder="Enter Title">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required name="email" class="form-control sign_popup_inputs" value="" id="signature_email" placeholder="Enter Email">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" required name="signature_address" class="form-control sign_popup_inputs" value="" id="signature_address" placeholder="Enter Address">

                            <div class="invalid-feedback"> Please enter Address</div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="signature_city" class="form-label">City</label>
                            <input type="text" required name="signature_city" class="form-control sign_popup_inputs" value="" id="signature_city" placeholder="Enter City">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" required name="signature_state" class="form-control sign_popup_inputs" value="" id="signature_state" placeholder="Enter State">
                            <div class="invalid-feedback"> Please enter State</div>

                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="signature_zip" class="form-label">Zip</label>
                            <input type="text" required name="signature_zip" class="form-control sign_popup_inputs" value="" id="signature_zip" placeholder="Enter Zip">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" required name="signature_cell_phone" pattern="^\d{3}-\d{3}-\d{4}$" class="form-control sign_popup_inputs" value="" id="signature_cell_phone" placeholder="Enter Cell Phone">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" required name="signature_office_phone" class="form-control sign_popup_inputs" pattern="^\d{3}-\d{3}-\d{4}$" value="" id="signature_office_phone" placeholder="Enter Office Phone">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control sign_popup_inputs" id="signature_comments" rows="3" placeholder="Enter Comments"></textarea>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Draw
                            </button>
                            <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Upload
                            </button>
                            <button class="nav-link" id="nav-choose-tab" data-bs-toggle="tab" data-bs-target="#nav-choose" type="button" role="tab" aria-controls="nav-choose" aria-selected="false">Type
                            </button>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div id="my_pad">
                                ...
                                <button id="save_signature_btn" type="submit" name="submit" style="float:left" class="btn btn-primary "><i class="fa fa-pencil-square-o"></i> Save
                                    Signature
                                </button>
                        ...
                        <div class="tab-pane fade" id="nav-choose" role="tabpanel" aria-labelledby="nav-choose-tab">
                            <div class="input-group" style="margin-top:20px;">
                                <input type="text" placeholder="Type your name to sign" class="form-control" id="signature_type_input">
                            </div>
                            <div class="type_preview_box">
                                <div class="choose_sign_option1 choose_sign_div">
                                    <input type="radio" class="sign_radio" id="choose_sign_option1" value="1" name="choose_sign_radio" />
                                ...
                                <div class="choose_sign_option2 choose_sign_div">
                                    <input type="radio" class="sign_radio" id="choose_sign_option2" value="2" name="choose_sign_radio" />
                                ...
                                <div class="choose_sign_option3 choose_sign_div">
                                    <input type="radio" class="sign_radio" id="choose_sign_option3" value="3" name="choose_sign_radio" />
            ...
            <div class="carousel-inner" style="width:100%;">
                ...
                foreach ($images2 as $image) { ?>
                    <div class="carousel-item pd-top-25 slide-image-<?= $k; ?>">
                        ...
                        <img src="<?php echo $image['src']; ?>" data-image-id="<?php echo $image['id']; ?>" class="d-block w-100 responsive carousel-img" alt="...">
...
<div class="offcanvas offcanvas-none" tabindex="-1" id="offcanvasMapImage" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body" style="border-top:1px solid #ccc">
        ...
        <div id="proposalMapCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#proposalMapCarousel" data-bs-slide="prev">
                <span class="carousel-control-prev-icon custom-carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#proposalMapCarousel" data-bs-slide="next">
                <span class="carousel-control-next-icon custom-carousel-control-next-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Next</span>
            </button>
        </div>
...
<div class="offcanvas offcanvas-none offcanvas-410" tabindex="-1" id="offcanvasRight3" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="ask_question" rows="4" minlength="20" required placeholder="Enter Question"></textarea>
                ...
                <div class="col-md-12 text-right mt-3">
                    <button id="ask_question_btn" type="submit" name="submit" class="btn btn-primary pave-btn pull-right"><i class="fa fa-pencil-square-o"></i>
                        Ask Question
                    </button>
...
<?php
if ($proposal->getAuditKey()) { ?>
    <div class="offcanvas offcanvas-none" tabindex="-1" id="offcanvasRight4" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body pad-top-0">
            <div class="row">
                ...
                <iframe id="auditIframe" class="embed-responsive-item audit-full-height" data-src="<?php echo $proposal->getAuditReportUrl(true); ?>" allowfullscreen></iframe>
            </div>
        </div>
    </div>
<?php } ?>
<!-- end ask question offcanvas-->
<!-- Service offcanvas-->
<div class="offcanvas offcanvas-none offcanvas-410" tabindex="-1" id="serviceOffcanvasRight" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
...
<div class="offcanvas offcanvas-none offcanvas-410" tabindex="-1" id="mobileImageInfo" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
...
<!-- end service offcanvas-->
<!-- Image-Info offcanvas-->
<div class="offcanvas offcanvas-none offcanvas-410" tabindex="-1" id="mobileImageInfoNote" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
...
<div class="offcanvas offcanvas-none offcanvas-410" tabindex="-1" id="offcanvasInfo" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
...
<div class="offcanvas offcanvas-none offcanvas-410" tabindex="-1" id="offcanvasPreProposal" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header">
        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo site_url('static/images/snagit2.png') ?>" class="d-block w-100 pre-popup-img" alt="...">
                ...
                <div class="carousel-item">
                    <img src="<?php echo site_url('static/images/snagit3.png') ?>" class="d-block w-100 pre-popup-img" alt="...">
                    <div class="carousel-caption d-none d-md-block">
    ...
    <div class="offcanvas-footer preproposal-offcanvas-footer">
        <span><span><input type="checkbox" name="dont_show" id="dont_show_pre_popup" value="1"></span><span style="    margin: 0px 0px 0px 10px;vertical-align: text-top;">Don't show me this again </span></span>
        <span class="canvas-close-ok-btn"><button type="button" class="btn btn-primary btn-sm  pave-btn canvas-btn-w-100 close_pre_popup" data-bs-dismiss="offcanvas" aria-label="Close">Ok</button></span>
    </div>
</div>
...
<div class="offcanvas offcanvas-none" tabindex="-1" id="proposalServiceLinks" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body pad-top-0">
        <div class="row">
            ...
            <iframe id="proposalServiceLinksIframe" class="embed-responsive-item full-height-service-link" allowfullscreen></iframe>
        </div>
    </div>
</div>
...
?>
    ...
    <?php if (!$buttonShow) { ?>
        ...
        <div class="offcanvas  VideoPlayersOffcanvas" tabindex="-1" id="VideoPlayersOffcanvas_<?php echo $video->getId(); ?>" aria-labelledby="offcanvasRightLabel">
            ...
            <div class="offcanvas-body pad-top-0 video_player_iframe_body" id="video_player_iframe_body_<?php echo $video->getId(); ?>">
                ...
                <iframe class="embed-responsive-item proposal_video_ifram <?php echo $iframVideoClass; ?>" data-video-type="<?= $videoType; ?>" video_id="<?php echo $video->getId(); ?>" id="embed-responsive-video-<?php echo $video->getId(); ?>" src="<?php echo $finalUrl . $autoplay; ?>" style="-webkit-overflow-scrolling:touch;" allowfullscreen allow="autoplay"></iframe>
            </div>
        </div>
...
?>
    ...
    <?php if (!$buttonShow) { ?>
        ...
        <!-- testProposal Video Opens here -->
        <div class="offcanvas  VideoPlayersOffcanvas" tabindex="-1" id="VideoPlayersOffcanvas_<?php echo $proposal_intro_video->getId(); ?>" aria-labelledby="offcanvasRightLabel">

            <span class="video-close-right-btn close_video_popup" data-video-id="<?php echo $proposal_intro_video->getId(); ?>">
                <button type="button" class="btn-close text-reset btn-close-white" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </span>

            <div class="offcanvas-body pad-top-0 video_player_iframe_body" id="video_player_iframe_body_<?php echo $proposal_intro_video->getId(); ?>">
                <!-- <div class="videoLoaderDiv"><div class="spinner-border text-primary video-spinner" role="status" aria-hidden="true"></div><span class="spinner-text">Loading </span></div> -->
                <iframe class="embed-responsive-item proposal_video_ifram <?php echo $iframVideoClass; ?>" data-video-type="<?= $videoType; ?>" video_id="<?php echo $proposal_intro_video->getId(); ?>" id="embed-responsive-video-<?php echo $proposal_intro_video->getId(); ?>" src="<?php echo $finalUrl . $autoplay; ?>" style="-webkit-overflow-scrolling:touch;" allowfullscreen allow="autoplay"></iframe>
            </div>
        </div>
        <!--End Proposal Video Opens here -->
...
?>
            <div class="offcanvas offcanvas-none" tabindex="-1" id="service_image_offcanvas_<?= $service->getServiceId(); ?>" aria-labelledby="offcanvasRightLabel" style="top: 0;overflow-y: scroll;display:block">
                ...
                <div class="offcanvas-body" style="border-top:1px solid #ccc">
                    ...
                    <!-- <button type="button" class="btn-close text-reset big_close_btn " style="top: 2px;right: 15px;z-index: 9999;"  data-bs-dismiss="offcanvas"
                                        aria-label="Close"></button>    -->
                    <div id="service_image_carousel_<?= $service->getServiceId(); ?>" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false" data-bs-wrap="false">
                        <div class="carousel-inner" style="width:100%;">
                        ...
                        <button class="carousel-control-prev" style="margin-top: 30px;height: calc(100vh - 12vh);" type="button" data-bs-target="#service_image_carousel_<?= $service->getServiceId(); ?>" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon custom-carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" style="margin-top: 30px;height: calc(100vh - 12vh);" type="button" data-bs-target="#service_image_carousel_<?= $service->getServiceId(); ?>" data-bs-slide="next">
                            <span class="carousel-control-next-icon custom-carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Next</span>
                        </button>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal"><i class="fa fa-fw fa-check-circle"></i> Ok
                </button>
...
<!--Customer check list  submit Modal popup-->
...
<div tabindex="-1" class="offcanvas offcanvas-none  offcanvasChecklist" id="offcanvasChecklist" aria-labelledby="offcanvasRightLabel" style="top: 0;overflow-y: scroll;display:block">
    <input type="hidden" value="<?php if (isset($proposalChecklistData)) {
                                    echo "1";
                                } else {
                                    echo "0";
                                }  ?>" id="checkCustomerChecklistData">
    <div class="offcanvas-header">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" required name="billing_contact" value="<?php if (isset($proposalChecklistData)) {
                                                                                            echo $proposalChecklistData->getBillingContact();
                                                                                        } else {
                                                                                            echo $proposal->getClient()->getFirstName() . " " . $proposal->getClient()->getLastName();
                                                                                        } ?>" class="form-control" id="billing_contact" placeholder="Enter Billing Contact">
                            <div class="invalid-feedback"> Please enter Billing Contact</div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="billing_phone" class="form-label">Phone</label>
                            <input type="text" required name="billing_phone" pattern="^\d{3}-\d{3}-\d{4}$" class="form-control sign_popup_inputs" id="billing_phone" placeholder="Enter Phone" value="<?php if (isset($proposalChecklistData)) {
                                                                                                                                                                                                            echo $proposalChecklistData->getBillingPhone();
                                                                                                                                                                                                        } else {
                                                                                                                                                                                                            echo $proposal->getClient()->getBillingBusinessPhone();
                                                                                                                                                                                                        } ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required name="billing_email" class="form-control sign_popup_inputs" value="<?php if (isset($proposalChecklistData)) {
                                                                                                                                                                                    echo $proposalChecklistData->getBillingEmail();
                                                                                                                                                                                } else {
                                                                                                                                                                                    echo $proposal->getClient()->getBillingEmail();
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control sign_popup_inputs" name="billing_address" id="billing_address" rows="3" placeholder=" Please Billing Address"><?php if (isset($proposalChecklistData)) {
                                                                                                                                                                            echo $proposalChecklistData->getBillingAddress();
                                                                                                                                                                        } else {
                                                                                                                                                                            echo $proposal->getClient()->getBillingAddress() . ", " . $proposal->getClient()->getBillingCity() . ", " . $proposal->getClient()->getBillingState() . ", " . $proposal->getClient()->getBillingZip();
                                                                                                                                                                        } ?></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" required name="property_owner_name" class="form-control sign_popup_inputs" value="<?php if (isset($proposalChecklistData)) {
                                                                                                                                        echo $proposalChecklistData->getPropertyOwnerName();
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" required name="customer_phone" pattern="^\d{3}-\d{3}-\d{4}$" class="form-control sign_popup_inputs" value="<?php if (isset($proposalChecklistData)) {
                                                                                                                                                                echo $proposalChecklistData->getCustomerPhone();
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for="signature_email" class="form-label">Email</label>
                            <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required name="customer_email" class="form-control sign_popup_inputs" value="<?php if (isset($proposalChecklistData)) {
                                                                                                                                                                                    echo $proposalChecklistData->getCustomerEmail();
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control sign_popup_inputs" id="legal_address" name="legal_address" rows="3" placeholder=" Please Legal Address"> <?php if (isset($proposalChecklistData)) {
                                                                                                                                                                        echo $proposalChecklistData->getLegalAddress();
                                                                                                                                                                    } ?> </textarea>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" required name="onsite_contact" class="form-control sign_popup_inputs" value="<?php if (isset($proposalChecklistData)) {
                                                                                                                                echo $proposalChecklistData->getOnsiteContact();
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="signature_cell_phone" class="form-label">Phone</label>
                            <input type="text" required name="onsite_phone" pattern="^\d{3}-\d{3}-\d{4}$" class="form-control sign_popup_inputs" value="<?php if (isset($proposalChecklistData)) {
                                                                                                                                                            echo $proposalChecklistData->getOnsitePhone();
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="signature_email" class="form-label">Email</label>
                            <input type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required name="onsite_email" class="form-control sign_popup_inputs" value="<?php if (isset($proposalChecklistData)) {
                                                                                                                                                                                    echo $proposalChecklistData->getOnsiteEmail();
                                                                                                                                                                                } ?>" id="onsite_email" placeholder="Enter  Email">
                            <input type="hidden" id="onsite_email" value="<?php if (isset($proposalChecklistData)) {
                                                                                echo $proposalChecklistData->getOnsiteEmail();
                                                                            } ?>">
                            <div class="invalid-feedback"> Please enter a valid Email</div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="radio" class="invoicing_portal" id="invoicing_portal_yes" name="invoicing_portal" value="Yes" <?php if (isset($proposalChecklistData) && $proposalChecklistData->getInvoicingPortal() == "Yes") {
                                                                                                                                            echo "checked";
                                                                                                                                        } ?>> Yes &nbsp;
                            <input type="radio" class="invoicing_portal" id="invoicing_portal_no" name="invoicing_portal" checked value="No" <?php if (isset($proposalChecklistData) && ($proposalChecklistData->getInvoicingPortal() == "No")) {
                                                                                                                                                    echo "checked";
                                                                                                                                                } ?>> No
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea name="special_instruction" class="form-control sign_popup_inputs" id="special_instruction" rows="3" placeholder=" Please Special Instructions"><?php if (isset($proposalChecklistData)) {
                                                                                                                                                                                            echo $proposalChecklistData->getSpecialInstructions();
                                                                                                                                                                                        } ?>
                                        </textarea>
                    ...
                    <div class="col-md-12 text-right mt2rem">
                        <button id="save_checklist_btn" type="submit" name="submit" style="float:right" class="btn btn-primary  pull-right"><i class="fa fa-pencil-square-o"></i>Save
...
<script type="text/javascript">
    ...
    $('#save_checklist_btn').on('click', function() {
