    ...
    <div id="content" class="clearfix dashboard">
        <div class="widthfix">
            <div class="content-box light">
                <?php if (help_box(16)) {
                    ?>
                    <div class="help tiptip center"
                         style="position: absolute; left: 99%; margin-left: -55px; top: 143px; z-index: 200;"
                         title="Help"><?php help_box(16, true) ?></div>
                    <?php
                } ?>
                <!-- <div class="box-header clearfix" style="height: 20px;">
                                
                    <div class="half left">
                        <form action="<?php echo site_url('proposals/search') ?>" method="post">
                            <input type="text" value="Enter Proposal Name / Job #" title="Enter Proposal Name"
                                   name="searchProposal" id="searchProposal"
                                   style="width: 200px; float: left; margin-right: 3px; text-align: center;"
                                   class="text"
                                   onblur="if (this.value == '') {this.value = 'Enter Proposal Name / Job #';}"
                                   onfocus="$('#searchClient').val('Enter Contact Name'); if (this.value == 'Enter Proposal Name / Job #') {this.value = '';}">
                    ...
                    <div class="half right">
                        <form action="<?php echo site_url('clients/search') ?>" method="post">
                            ...
                            <input type="text" value="Enter Contact Name" title="Enter Contact Name" name="searchClient"
                                   id="searchClient"
                                   style="width: 200px; float: right; margin-right: 3px; text-align: center;"
                                   class="text" onblur="if (this.value == '') {this.value = 'Enter Contact Name';}"
                                   onfocus="$('#searchProposal').val('Enter Proposal Name'); if (this.value == 'Enter Contact Name') {this.value = '';}">
                        </form>
                    </div> 
                </div>-->
                <div class="box-content padded">
                    ...
                    <li id="quick-add-proposal2">
                        <a href="#" class="tiptip add_proposal_btn" title="Add a new proposal " style="width: 244px;">
                            <span class="icon"></span>
                            <span class="label">Add Proposal</span>
                        </a>
                    </li>

                        <!-- <li id="quick-add-proposal">
                            <a href="<?php echo site_url('clients/add') ?>" class="tiptip"
                               title="Add a new contact for adding a proposal">
                                <span class="icon"></span>
                                <span class="label">Add Proposal <br> New Contact</span>
                            </a>
                        </li> -->
                        <li id="quick-add-client">
                            <a href="javascript:void(0);" class="tiptip add_contact_btn" title="Add a new contact">
                                <span class="icon"></span>
                                <span class="label">Add Contact</span>
                            </a>
                        </li>
                        <li id="quick-proposals">
                            <a href="<?php echo site_url('proposals') ?>" class="tiptip"
                               title="Edit your proposals here">
                                <span class="icon"></span>
                ...
                -->
                        <li id="quick-calculators">
                            <a href="<?php echo site_url('account/calculators') ?>" class="tiptip"
            ...
            $this->load->view('account/events');

            // Show notifications if there are any
            if ($account->isAdministrator()) {
                 $this->load->view('account/notifications');
 
            }
            // Show stats
            $this->load->view('account/dashboard-stats');
            ?>
                                ...
                                foreach ($top_ten as $proposal) {
                                    ...
                                    <tr class="<?php echo ($k % 2 == 0) ? 'even' : ''; ?>">
                                        ...
                                        <td class="centered"><a class="tiptip"
                                                                title="View <?php echo $proposal->projectName ?> Proposal"
                                                                href="<?php echo site_url('proposals/edit/' . $proposal->proposalId . '/preview') ?>"><?php echo $proposal->projectName ?></a>
                                        </td>
                                        <td class="centered">
                        ...
                        if (!count($leads)) {
                           ...
                           // echo "<pre>";print_r($leads);die;
                            foreach ($leads as $lead) {
                                ...
                                <tr class="<?php echo ($k % 2 == 0) ? 'even' : ''; ?>">
                                    <td class="centered"><?php echo $k; ?></td>
                                    <td class="centered"><?php echo date('m/d/Y', $lead->dueDate) ?></td>
...
var tabCheck = <?php echo $checkTabActive; ?>;
if(tabCheck==0){
    ...
    if( localStorage.getItem("dashboardTabIndex")!=3 && localStorage.getItem("dashboardTabIndex")!=4 && localStorage.getItem("dashboardTabIndex")!=5){
        ...
        $('.statTypeSelector').css("visibility", "hidden");
            ...
            function updateStatBoxes() {
                ...
                $.ajax({
                    url: '<?php echo site_url('ajax/dashboardStats') ?>',
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                        range: range,
                ...
                if(localStorage.getItem("dashboardTabIndex")==0){
                    ...
                    if (typeof oTable !== 'undefined') {
                        ...
                        oTable = $("#userStatsTable").DataTable({
                            "bStateSave": true,
                            "ajax": {
                                "url": '<?php echo site_url('ajax/dashboardTable'); ?>',
                                "type": 'POST',
                                "data": buildTableData
                            },
                            "bJQueryUI": true,
                    ...
                    if (typeof oLeadsTable !== 'undefined') {
                        ...
                        "bStateSave": true,
                        "ajax": {
                            "url": '<?php echo site_url('ajax/dashboardTableLeads'); ?>',
                            "type": 'POST',
                            "data": buildTableData
                        },
                        "bJQueryUI": true,
            ...
            function updateSalesTargetsTable() {
                ...
                if (oSalesTargetsTable) {
                    ...
                    oSalesTargetsTable = $("#salesTargetsStatsTable").on('processing.dt', function (e, settings, processing) {
                        ...
                        "bInfo" : false,
                        "ajax": {
                            "url": '<?php echo site_url('ajax/dashboardTableSalesTargets'); ?>',
                            "type": "POST",
                            "data": buildTableData
                        },
                        "aoColumns": [
                ...
                if($('.business_table_breakdown.update-button').data('val')=='breakdown'){
                    ...
                    if (btTable){
                        ...
                        .DataTable({
                            ...
                            "bInfo" : false,
                            "ajax": {
                                url: "<?php echo site_url('ajax/ajaxGetDashboardBusinessTypes');?>",
                                data: function(d) {
...
function loadUserBusinessTypePie() {
    var aoData = {
            ...
            var jsonData = $.ajax({
                url: "/ajax/businessTypeDashboardInfoPie",
                dataType: "json",
                async: false,
                data: aoData,
                type: 'post',
...
stTable = $('#business_type_breakdown_table').DataTable({
    ...
    "info":false,
    "ajax": {
            url: "<?php echo site_url('ajax/businessTypeBreakdownDashboardTable');?>",
            data: function(d) {
                d.user = $("#statsUser").val();
                d.accountId = $("#statsUser").find(':selected').data('account');
                d.branchId = $("#statsUser").find(':selected').data('branch');
            ...
            function updateStatusTable() {
                ...
                if (oStatusTable) {
                    ...
                    oStatusTable = $("#StatusStatsTable").on('processing.dt', function (e, settings, processing) {
                        ...
                        "ajax": {
                            "url": '<?php echo site_url('ajax/dashboardStatusTable'); ?>',
                            "type": "POST",
                            "data": buildTableData
                        },
