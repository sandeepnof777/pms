...
|
*/
$config['site_name'] = "Pavement Layers";
...
if(!strstr($_SERVER['HTTP_HOST'], 'pms.pavementlayers.com') && !strstr($_SERVER['HTTP_HOST'], 'staging.pavementlayers.com') && !strstr($_SERVER['HTTP_HOST'], 'dev.pavementlayers.com')){
    // Use the development database for all other environments
    $config['live'] = false;
    $config['psa_endpoint'] = 'https://local.psa/api/';
}
