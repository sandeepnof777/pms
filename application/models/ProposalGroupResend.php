...
/**
 * @ORM\Entity
 * @ORM\Table(name="proposal_group_resends")
 */
class ProposalGroupResend extends \MY_Model
{
    /**
     * @ORM\Id
   ...
   /**
     ...
     * @return mixed
     */
    public function getExcludedOverride()
    {
        return $this->excluded_override;
    }
    

    /**
     * @param mixed $excluded_override
     */
    public function setExcludedOverride($excluded_override)
    {
        $this->excluded_override = $excluded_override;
    }
