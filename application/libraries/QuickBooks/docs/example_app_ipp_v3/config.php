...
$site = 'http://local.pms_live';
//$site = 'http://dev2.pavementlayers.com';

// Require the library code
//require_once dirname(__FILE__) . '/../../QuickBooks.php';

// Your OAuth token (Intuit will give you this when you register an Intuit Anywhere app)
$token = '2b5e4dd1beb47b40c5b9e6bbd7b6006c146d';
//$token = '8a7d0cb6bfabcb45baba581b7bed4fed3d73';
...
$oauth_consumer_key = 'qyprdkj2SGBi5QrFYOQ8MrMBQBcMVD';
$oauth_consumer_secret = 'KmIk60ID0SH04WSOJuyF5P03GYUfk4FXiZLeGd3o';

//$oauth_consumer_key = 'qyprdlWj1DNmXwhAdCIBzJDDJgGPB4';
//$oauth_consumer_secret = 'ODzPTGRMzVLGb27m4tBG2WMhh6UDXmF4X9R6Tvff';

// This is the URL of your OAuth auth handler page
$quickbooks_oauth_url = $site . '/application/libraries/QuickBooks/docs/example_app_ipp_v3/oauth.php';

// This is the URL to forward the user to after they have connected to IPP/IDS via OAuth
$quickbooks_success_url = $site . '/account/quickbooks/success';

// This is the menu URL script 
$quickbooks_menu_url = $site . '/application/libraries/QuickBooks/docs/example_app_ipp_v3/menu.php';

// This is a database connection string that will be used to store the OAuth credentials 
// $dsn = 'pgsql://username:password@hostname/database';
// $dsn = 'mysql://username:password@hostname/database';
$dsn = 'mysql://pms:ejAurK4W9XcpHh@localhost/pms_dev';

// You should set this to an encryption key specific to your app
$encryption_key = 'plllqba';
