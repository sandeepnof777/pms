                    ...
                    <div id="step1">
                        <table class="boxed-table" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <label style="width: 145px;">Total Users</label>
                                    ...
                                    <select name="seatsNumber" id="seatsNumber" class="text required tiptip" title="Please select the number of users">
                                        <?php
                                        for ($i = 1; $i <= 55; $i++) {
                                            ?>
                                            <option value="<?php echo $i; ?>" <?php if ($i == 1) { ?> selected="selected" <?php } ?>><?php echo $i ?> User(s)</option><?php
                                        }
                                        ?>
                                    </select>
                                </td>
                            ...
                            <tr class="even">
                                ...
                                <td>
                                    <label style="">Total Cost: </label>
                                    <label style="text-align: left;">$<span class="cost" style="color: #000;">2,100.00</span></label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                   <!-- <label>Do you have a trial account?</label>
                                    <select name="trial_account" id="trial_account">
                                        <option>No</option>
                                        <option>Yes</option>
                                    </select>-->
...
//        return Stripe.validateExpiry(value, $(".card-expiry-year").val());
    ...
    $(document).ready(function () {
        ...
        Stripe.setPublishableKey('pk_R4rOVWlhd9dVyeO1yzYhffwCT8xbF'); //mike live
                ...
                var request = $.ajax({
                    ...
                    success:function (data) {
                        if (data.success) {
                            ...
                            $("#error-message-popup-text").html('Your payment has been approved! We will contact you within 24h to set up your account.');
